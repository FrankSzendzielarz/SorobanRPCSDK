...
{
    /// <summary>Custom marshaller for Stellar.SorobanAuthorizationEntryEncodeRequest</summary>
    public static class SorobanAuthorizationEntryEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SorobanAuthorizationEntryEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SorobanAuthorizationEntryEncodeRequest
            if (!model.IsDefined(typeof(Stellar.SorobanAuthorizationEntryEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SorobanAuthorizationEntryEncodeRequest), false);
