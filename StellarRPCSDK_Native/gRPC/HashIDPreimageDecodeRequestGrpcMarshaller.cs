...
{
    /// <summary>Custom marshaller for Stellar.HashIDPreimageDecodeRequest</summary>
    public static class HashIDPreimageDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static HashIDPreimageDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.HashIDPreimageDecodeRequest
            if (!model.IsDefined(typeof(Stellar.HashIDPreimageDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.HashIDPreimageDecodeRequest), false);
