...
{
    /// <summary>Custom marshaller for Stellar.FloodAdvertEncodeResponse</summary>
    public static class FloodAdvertEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static FloodAdvertEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.FloodAdvertEncodeResponse
            if (!model.IsDefined(typeof(Stellar.FloodAdvertEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.FloodAdvertEncodeResponse), false);
