...
{
    /// <summary>Custom marshaller for Stellar.TimeSlicedPeerDataDecodeRequest</summary>
    public static class TimeSlicedPeerDataDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static TimeSlicedPeerDataDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TimeSlicedPeerDataDecodeRequest
            if (!model.IsDefined(typeof(Stellar.TimeSlicedPeerDataDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.TimeSlicedPeerDataDecodeRequest), false);
