...
{
    /// <summary>Custom marshaller for Stellar.CreateContractArgsV2EncodeResponse</summary>
    public static class CreateContractArgsV2EncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static CreateContractArgsV2EncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.CreateContractArgsV2EncodeResponse
            if (!model.IsDefined(typeof(Stellar.CreateContractArgsV2EncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.CreateContractArgsV2EncodeResponse), false);
