...
{
    /// <summary>Custom marshaller for Stellar.ManageDataResultEncodeResponse</summary>
    public static class ManageDataResultEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ManageDataResultEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ManageDataResultEncodeResponse
            if (!model.IsDefined(typeof(Stellar.ManageDataResultEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ManageDataResultEncodeResponse), false);
