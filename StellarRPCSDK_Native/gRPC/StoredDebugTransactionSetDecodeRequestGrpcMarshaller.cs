...
{
    /// <summary>Custom marshaller for Stellar.StoredDebugTransactionSetDecodeRequest</summary>
    public static class StoredDebugTransactionSetDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static StoredDebugTransactionSetDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.StoredDebugTransactionSetDecodeRequest
            if (!model.IsDefined(typeof(Stellar.StoredDebugTransactionSetDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.StoredDebugTransactionSetDecodeRequest), false);
