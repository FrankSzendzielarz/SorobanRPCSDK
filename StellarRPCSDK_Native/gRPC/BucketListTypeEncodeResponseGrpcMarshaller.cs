...
{
    /// <summary>Custom marshaller for Stellar.BucketListTypeEncodeResponse</summary>
    public static class BucketListTypeEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static BucketListTypeEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.BucketListTypeEncodeResponse
            if (!model.IsDefined(typeof(Stellar.BucketListTypeEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.BucketListTypeEncodeResponse), false);
