...
{
    /// <summary>Custom marshaller for Stellar.DiagnosticEventDecodeRequest</summary>
    public static class DiagnosticEventDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static DiagnosticEventDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.DiagnosticEventDecodeRequest
            if (!model.IsDefined(typeof(Stellar.DiagnosticEventDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.DiagnosticEventDecodeRequest), false);
