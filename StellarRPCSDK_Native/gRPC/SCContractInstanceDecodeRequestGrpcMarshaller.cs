...
{
    /// <summary>Custom marshaller for Stellar.SCContractInstanceDecodeRequest</summary>
    public static class SCContractInstanceDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SCContractInstanceDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCContractInstanceDecodeRequest
            if (!model.IsDefined(typeof(Stellar.SCContractInstanceDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SCContractInstanceDecodeRequest), false);
