...
{
    /// <summary>Custom marshaller for Stellar.HashIDPreimageEncodeRequest</summary>
    public static class HashIDPreimageEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static HashIDPreimageEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.HashIDPreimageEncodeRequest
            if (!model.IsDefined(typeof(Stellar.HashIDPreimageEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.HashIDPreimageEncodeRequest), false);
