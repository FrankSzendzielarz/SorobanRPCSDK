...
{
    /// <summary>Custom marshaller for Stellar.PaymentOpDecodeResponse</summary>
    public static class PaymentOpDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static PaymentOpDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.PaymentOpDecodeResponse
            if (!model.IsDefined(typeof(Stellar.PaymentOpDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.PaymentOpDecodeResponse), false);
