...
{
    /// <summary>Custom marshaller for Stellar.SCMapEncodeResponse</summary>
    public static class SCMapEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SCMapEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCMapEncodeResponse
            if (!model.IsDefined(typeof(Stellar.SCMapEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SCMapEncodeResponse), false);
