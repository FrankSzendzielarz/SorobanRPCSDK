...
namespace Stellar.RPC.AOT
{
    ...
    public static class ContractCodeEntryextUnioncase_0GrpcMarshaller
    {
        ...
        /// <summary>Marshaller for Stellar.ContractCodeEntry+extUnion+case_0</summary>
        public static readonly Marshaller<Stellar.ContractCodeEntry.extUnion.case_0> ContractCodeEntry_extUnion_case_0Marshaller = Marshallers.Create<Stellar.ContractCodeEntry.extUnion.case_0>(
