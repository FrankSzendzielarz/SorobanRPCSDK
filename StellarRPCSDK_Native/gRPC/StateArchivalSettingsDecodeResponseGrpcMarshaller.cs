...
{
    /// <summary>Custom marshaller for Stellar.StateArchivalSettingsDecodeResponse</summary>
    public static class StateArchivalSettingsDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static StateArchivalSettingsDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.StateArchivalSettingsDecodeResponse
            if (!model.IsDefined(typeof(Stellar.StateArchivalSettingsDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.StateArchivalSettingsDecodeResponse), false);
