...
{
    /// <summary>Custom marshaller for Stellar.LedgerBoundsEncodeRequest</summary>
    public static class LedgerBoundsEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static LedgerBoundsEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.LedgerBoundsEncodeRequest
            if (!model.IsDefined(typeof(Stellar.LedgerBoundsEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.LedgerBoundsEncodeRequest), false);
