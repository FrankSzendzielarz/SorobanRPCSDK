...
{
    /// <summary>Custom marshaller for Stellar.ClaimAtomEncodeRequest</summary>
    public static class ClaimAtomEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ClaimAtomEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ClaimAtomEncodeRequest
            if (!model.IsDefined(typeof(Stellar.ClaimAtomEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ClaimAtomEncodeRequest), false);
