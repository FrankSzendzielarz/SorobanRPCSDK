...
{
    /// <summary>Custom marshaller for Stellar.SCSpecTypeUDTDecodeResponse</summary>
    public static class SCSpecTypeUDTDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SCSpecTypeUDTDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCSpecTypeUDTDecodeResponse
            if (!model.IsDefined(typeof(Stellar.SCSpecTypeUDTDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SCSpecTypeUDTDecodeResponse), false);
