...
{
    /// <summary>Custom marshaller for Stellar.SurveyResponseMessageEncodeRequest</summary>
    public static class SurveyResponseMessageEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SurveyResponseMessageEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SurveyResponseMessageEncodeRequest
            if (!model.IsDefined(typeof(Stellar.SurveyResponseMessageEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SurveyResponseMessageEncodeRequest), false);
