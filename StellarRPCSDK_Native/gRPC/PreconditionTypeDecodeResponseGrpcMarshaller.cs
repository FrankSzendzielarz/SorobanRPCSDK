...
{
    /// <summary>Custom marshaller for Stellar.PreconditionTypeDecodeResponse</summary>
    public static class PreconditionTypeDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static PreconditionTypeDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.PreconditionTypeDecodeResponse
            if (!model.IsDefined(typeof(Stellar.PreconditionTypeDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.PreconditionTypeDecodeResponse), false);
