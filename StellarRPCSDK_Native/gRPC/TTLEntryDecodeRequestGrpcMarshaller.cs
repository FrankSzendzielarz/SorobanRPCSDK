...
{
    /// <summary>Custom marshaller for Stellar.TTLEntryDecodeRequest</summary>
    public static class TTLEntryDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static TTLEntryDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TTLEntryDecodeRequest
            if (!model.IsDefined(typeof(Stellar.TTLEntryDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.TTLEntryDecodeRequest), false);
