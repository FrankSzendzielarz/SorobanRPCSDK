...
{
    /// <summary>Custom marshaller for Stellar.UpgradeTypeDecodeResponse</summary>
    public static class UpgradeTypeDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static UpgradeTypeDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.UpgradeTypeDecodeResponse
            if (!model.IsDefined(typeof(Stellar.UpgradeTypeDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.UpgradeTypeDecodeResponse), false);
