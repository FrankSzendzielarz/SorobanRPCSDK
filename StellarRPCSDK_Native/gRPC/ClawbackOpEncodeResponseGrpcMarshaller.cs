...
{
    /// <summary>Custom marshaller for Stellar.ClawbackOpEncodeResponse</summary>
    public static class ClawbackOpEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ClawbackOpEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ClawbackOpEncodeResponse
            if (!model.IsDefined(typeof(Stellar.ClawbackOpEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ClawbackOpEncodeResponse), false);
