...
{
    /// <summary>Custom marshaller for Stellar.AssetTypeEncodeResponse</summary>
    public static class AssetTypeEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static AssetTypeEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.AssetTypeEncodeResponse
            if (!model.IsDefined(typeof(Stellar.AssetTypeEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.AssetTypeEncodeResponse), false);
