...
{
    /// <summary>Custom marshaller for Stellar.BoolWrapper</summary>
    public static class BoolWrapperGrpcMarshaller
    {
        // Static constructor to configure type
        static BoolWrapperGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.BoolWrapper
            if (!model.IsDefined(typeof(Stellar.BoolWrapper)))
            {
                var metaType = model.Add(typeof(Stellar.BoolWrapper), false);
