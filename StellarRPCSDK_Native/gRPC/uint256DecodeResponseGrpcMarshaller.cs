...
{
    /// <summary>Custom marshaller for Stellar.uint256DecodeResponse</summary>
    public static class uint256DecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static uint256DecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.uint256DecodeResponse
            if (!model.IsDefined(typeof(Stellar.uint256DecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.uint256DecodeResponse), false);
