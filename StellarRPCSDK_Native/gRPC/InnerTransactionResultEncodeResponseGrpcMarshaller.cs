...
{
    /// <summary>Custom marshaller for Stellar.InnerTransactionResultEncodeResponse</summary>
    public static class InnerTransactionResultEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static InnerTransactionResultEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.InnerTransactionResultEncodeResponse
            if (!model.IsDefined(typeof(Stellar.InnerTransactionResultEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.InnerTransactionResultEncodeResponse), false);
