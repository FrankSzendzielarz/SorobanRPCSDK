...
{
    /// <summary>Custom marshaller for Stellar.SCSpecTypeVecEncodeRequest</summary>
    public static class SCSpecTypeVecEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SCSpecTypeVecEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCSpecTypeVecEncodeRequest
            if (!model.IsDefined(typeof(Stellar.SCSpecTypeVecEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SCSpecTypeVecEncodeRequest), false);
