...
{
    /// <summary>Custom marshaller for Stellar.HelloEncodeRequest</summary>
    public static class HelloEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static HelloEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.HelloEncodeRequest
            if (!model.IsDefined(typeof(Stellar.HelloEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.HelloEncodeRequest), false);
