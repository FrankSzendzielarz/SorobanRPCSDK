...
{
    /// <summary>Custom marshaller for Stellar.OfferEntryFlagsEncodeRequest</summary>
    public static class OfferEntryFlagsEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static OfferEntryFlagsEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.OfferEntryFlagsEncodeRequest
            if (!model.IsDefined(typeof(Stellar.OfferEntryFlagsEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.OfferEntryFlagsEncodeRequest), false);
