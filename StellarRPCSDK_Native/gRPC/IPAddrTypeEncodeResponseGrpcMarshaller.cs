...
{
    /// <summary>Custom marshaller for Stellar.IPAddrTypeEncodeResponse</summary>
    public static class IPAddrTypeEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static IPAddrTypeEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.IPAddrTypeEncodeResponse
            if (!model.IsDefined(typeof(Stellar.IPAddrTypeEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.IPAddrTypeEncodeResponse), false);
