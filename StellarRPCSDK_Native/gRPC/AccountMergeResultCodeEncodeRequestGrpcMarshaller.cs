...
{
    /// <summary>Custom marshaller for Stellar.AccountMergeResultCodeEncodeRequest</summary>
    public static class AccountMergeResultCodeEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static AccountMergeResultCodeEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.AccountMergeResultCodeEncodeRequest
            if (!model.IsDefined(typeof(Stellar.AccountMergeResultCodeEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.AccountMergeResultCodeEncodeRequest), false);
