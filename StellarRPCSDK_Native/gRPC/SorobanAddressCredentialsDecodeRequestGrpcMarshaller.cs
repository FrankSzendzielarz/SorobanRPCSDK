...
{
    /// <summary>Custom marshaller for Stellar.SorobanAddressCredentialsDecodeRequest</summary>
    public static class SorobanAddressCredentialsDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SorobanAddressCredentialsDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SorobanAddressCredentialsDecodeRequest
            if (!model.IsDefined(typeof(Stellar.SorobanAddressCredentialsDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SorobanAddressCredentialsDecodeRequest), false);
