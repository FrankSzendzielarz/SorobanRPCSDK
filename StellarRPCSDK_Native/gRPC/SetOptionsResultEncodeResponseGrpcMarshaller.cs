...
{
    /// <summary>Custom marshaller for Stellar.SetOptionsResultEncodeResponse</summary>
    public static class SetOptionsResultEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SetOptionsResultEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SetOptionsResultEncodeResponse
            if (!model.IsDefined(typeof(Stellar.SetOptionsResultEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SetOptionsResultEncodeResponse), false);
