...
{
    /// <summary>Custom marshaller for Stellar.Curve25519SecretEncodeRequest</summary>
    public static class Curve25519SecretEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static Curve25519SecretEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.Curve25519SecretEncodeRequest
            if (!model.IsDefined(typeof(Stellar.Curve25519SecretEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.Curve25519SecretEncodeRequest), false);
