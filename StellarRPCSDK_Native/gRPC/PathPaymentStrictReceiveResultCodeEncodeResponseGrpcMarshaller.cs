...
{
    /// <summary>Custom marshaller for Stellar.PathPaymentStrictReceiveResultCodeEncodeResponse</summary>
    public static class PathPaymentStrictReceiveResultCodeEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static PathPaymentStrictReceiveResultCodeEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.PathPaymentStrictReceiveResultCodeEncodeResponse
            if (!model.IsDefined(typeof(Stellar.PathPaymentStrictReceiveResultCodeEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.PathPaymentStrictReceiveResultCodeEncodeResponse), false);
