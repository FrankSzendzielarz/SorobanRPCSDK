...
{
    /// <summary>Custom marshaller for Stellar.PoolIDEncodeRequest</summary>
    public static class PoolIDEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static PoolIDEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.PoolIDEncodeRequest
            if (!model.IsDefined(typeof(Stellar.PoolIDEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.PoolIDEncodeRequest), false);
