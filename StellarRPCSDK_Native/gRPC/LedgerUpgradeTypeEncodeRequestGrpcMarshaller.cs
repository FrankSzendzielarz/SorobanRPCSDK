...
{
    /// <summary>Custom marshaller for Stellar.LedgerUpgradeTypeEncodeRequest</summary>
    public static class LedgerUpgradeTypeEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static LedgerUpgradeTypeEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.LedgerUpgradeTypeEncodeRequest
            if (!model.IsDefined(typeof(Stellar.LedgerUpgradeTypeEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.LedgerUpgradeTypeEncodeRequest), false);
