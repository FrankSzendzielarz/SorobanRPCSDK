...
{
    /// <summary>Custom marshaller for Stellar.PathPaymentStrictSendResultCodeEncodeResponse</summary>
    public static class PathPaymentStrictSendResultCodeEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static PathPaymentStrictSendResultCodeEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.PathPaymentStrictSendResultCodeEncodeResponse
            if (!model.IsDefined(typeof(Stellar.PathPaymentStrictSendResultCodeEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.PathPaymentStrictSendResultCodeEncodeResponse), false);
