...
{
    /// <summary>Custom marshaller for Stellar.SignatureHintEncodeRequest</summary>
    public static class SignatureHintEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SignatureHintEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SignatureHintEncodeRequest
            if (!model.IsDefined(typeof(Stellar.SignatureHintEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SignatureHintEncodeRequest), false);
