...
{
    /// <summary>Custom marshaller for Stellar.TransactionV0EncodeResponse</summary>
    public static class TransactionV0EncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static TransactionV0EncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TransactionV0EncodeResponse
            if (!model.IsDefined(typeof(Stellar.TransactionV0EncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.TransactionV0EncodeResponse), false);
