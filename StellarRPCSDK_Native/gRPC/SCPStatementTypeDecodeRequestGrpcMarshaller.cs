...
{
    /// <summary>Custom marshaller for Stellar.SCPStatementTypeDecodeRequest</summary>
    public static class SCPStatementTypeDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SCPStatementTypeDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCPStatementTypeDecodeRequest
            if (!model.IsDefined(typeof(Stellar.SCPStatementTypeDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SCPStatementTypeDecodeRequest), false);
