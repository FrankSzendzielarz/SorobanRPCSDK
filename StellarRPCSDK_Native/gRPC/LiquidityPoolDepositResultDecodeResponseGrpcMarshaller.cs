...
{
    /// <summary>Custom marshaller for Stellar.LiquidityPoolDepositResultDecodeResponse</summary>
    public static class LiquidityPoolDepositResultDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static LiquidityPoolDepositResultDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.LiquidityPoolDepositResultDecodeResponse
            if (!model.IsDefined(typeof(Stellar.LiquidityPoolDepositResultDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.LiquidityPoolDepositResultDecodeResponse), false);
