...
{
    /// <summary>Custom marshaller for Stellar.TransactionResultDecodeRequest</summary>
    public static class TransactionResultDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static TransactionResultDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TransactionResultDecodeRequest
            if (!model.IsDefined(typeof(Stellar.TransactionResultDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.TransactionResultDecodeRequest), false);
