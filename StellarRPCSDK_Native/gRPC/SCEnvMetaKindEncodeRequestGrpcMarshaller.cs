...
{
    /// <summary>Custom marshaller for Stellar.SCEnvMetaKindEncodeRequest</summary>
    public static class SCEnvMetaKindEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SCEnvMetaKindEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCEnvMetaKindEncodeRequest
            if (!model.IsDefined(typeof(Stellar.SCEnvMetaKindEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SCEnvMetaKindEncodeRequest), false);
