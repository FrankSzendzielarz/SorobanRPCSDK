...
{
    /// <summary>Custom marshaller for Stellar.ArchivalProofDecodeResponse</summary>
    public static class ArchivalProofDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ArchivalProofDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ArchivalProofDecodeResponse
            if (!model.IsDefined(typeof(Stellar.ArchivalProofDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ArchivalProofDecodeResponse), false);
