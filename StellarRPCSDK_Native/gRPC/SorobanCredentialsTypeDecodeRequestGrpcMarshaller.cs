...
{
    /// <summary>Custom marshaller for Stellar.SorobanCredentialsTypeDecodeRequest</summary>
    public static class SorobanCredentialsTypeDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SorobanCredentialsTypeDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SorobanCredentialsTypeDecodeRequest
            if (!model.IsDefined(typeof(Stellar.SorobanCredentialsTypeDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SorobanCredentialsTypeDecodeRequest), false);
