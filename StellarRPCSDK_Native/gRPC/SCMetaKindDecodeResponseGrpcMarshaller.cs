...
{
    /// <summary>Custom marshaller for Stellar.SCMetaKindDecodeResponse</summary>
    public static class SCMetaKindDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SCMetaKindDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCMetaKindDecodeResponse
            if (!model.IsDefined(typeof(Stellar.SCMetaKindDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SCMetaKindDecodeResponse), false);
