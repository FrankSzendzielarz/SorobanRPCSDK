...
{
    /// <summary>Custom marshaller for Stellar.AssetCode4EncodeRequest</summary>
    public static class AssetCode4EncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static AssetCode4EncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.AssetCode4EncodeRequest
            if (!model.IsDefined(typeof(Stellar.AssetCode4EncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.AssetCode4EncodeRequest), false);
