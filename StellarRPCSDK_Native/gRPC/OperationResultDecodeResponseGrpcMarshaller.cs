...
{
    /// <summary>Custom marshaller for Stellar.OperationResultDecodeResponse</summary>
    public static class OperationResultDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static OperationResultDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.OperationResultDecodeResponse
            if (!model.IsDefined(typeof(Stellar.OperationResultDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.OperationResultDecodeResponse), false);
