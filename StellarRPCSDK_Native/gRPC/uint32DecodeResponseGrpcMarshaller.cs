...
{
    /// <summary>Custom marshaller for Stellar.uint32DecodeResponse</summary>
    public static class uint32DecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static uint32DecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.uint32DecodeResponse
            if (!model.IsDefined(typeof(Stellar.uint32DecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.uint32DecodeResponse), false);
