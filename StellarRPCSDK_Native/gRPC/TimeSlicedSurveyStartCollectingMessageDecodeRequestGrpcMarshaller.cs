...
{
    /// <summary>Custom marshaller for Stellar.TimeSlicedSurveyStartCollectingMessageDecodeRequest</summary>
    public static class TimeSlicedSurveyStartCollectingMessageDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static TimeSlicedSurveyStartCollectingMessageDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TimeSlicedSurveyStartCollectingMessageDecodeRequest
            if (!model.IsDefined(typeof(Stellar.TimeSlicedSurveyStartCollectingMessageDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.TimeSlicedSurveyStartCollectingMessageDecodeRequest), false);
