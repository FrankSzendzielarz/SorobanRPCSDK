...
{
    /// <summary>Custom marshaller for Stellar.InflationResultCodeEncodeRequest</summary>
    public static class InflationResultCodeEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static InflationResultCodeEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.InflationResultCodeEncodeRequest
            if (!model.IsDefined(typeof(Stellar.InflationResultCodeEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.InflationResultCodeEncodeRequest), false);
