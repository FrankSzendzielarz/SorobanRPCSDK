...
{
    /// <summary>Custom marshaller for Stellar.LedgerHeaderHistoryEntryEncodeResponse</summary>
    public static class LedgerHeaderHistoryEntryEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static LedgerHeaderHistoryEntryEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.LedgerHeaderHistoryEntryEncodeResponse
            if (!model.IsDefined(typeof(Stellar.LedgerHeaderHistoryEntryEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.LedgerHeaderHistoryEntryEncodeResponse), false);
