...
{
    /// <summary>Custom marshaller for Stellar.MemoDecodeRequest</summary>
    public static class MemoDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static MemoDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.MemoDecodeRequest
            if (!model.IsDefined(typeof(Stellar.MemoDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.MemoDecodeRequest), false);
