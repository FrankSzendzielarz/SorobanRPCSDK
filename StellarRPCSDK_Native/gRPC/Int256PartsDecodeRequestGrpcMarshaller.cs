...
{
    /// <summary>Custom marshaller for Stellar.Int256PartsDecodeRequest</summary>
    public static class Int256PartsDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static Int256PartsDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.Int256PartsDecodeRequest
            if (!model.IsDefined(typeof(Stellar.Int256PartsDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.Int256PartsDecodeRequest), false);
