...
{
    /// <summary>Custom marshaller for Stellar.ColdArchiveHashEntryDecodeResponse</summary>
    public static class ColdArchiveHashEntryDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ColdArchiveHashEntryDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ColdArchiveHashEntryDecodeResponse
            if (!model.IsDefined(typeof(Stellar.ColdArchiveHashEntryDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ColdArchiveHashEntryDecodeResponse), false);
