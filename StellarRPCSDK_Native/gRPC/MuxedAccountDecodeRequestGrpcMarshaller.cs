...
{
    /// <summary>Custom marshaller for Stellar.MuxedAccountDecodeRequest</summary>
    public static class MuxedAccountDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static MuxedAccountDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.MuxedAccountDecodeRequest
            if (!model.IsDefined(typeof(Stellar.MuxedAccountDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.MuxedAccountDecodeRequest), false);
