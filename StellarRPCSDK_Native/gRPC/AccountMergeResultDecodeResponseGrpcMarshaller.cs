...
{
    /// <summary>Custom marshaller for Stellar.AccountMergeResultDecodeResponse</summary>
    public static class AccountMergeResultDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static AccountMergeResultDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.AccountMergeResultDecodeResponse
            if (!model.IsDefined(typeof(Stellar.AccountMergeResultDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.AccountMergeResultDecodeResponse), false);
