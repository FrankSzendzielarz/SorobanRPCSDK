...
{
    /// <summary>Custom marshaller for Stellar.DurationDecodeRequest</summary>
    public static class DurationDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static DurationDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.DurationDecodeRequest
            if (!model.IsDefined(typeof(Stellar.DurationDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.DurationDecodeRequest), false);
