...
{
    /// <summary>Custom marshaller for Stellar.MuxedAccount_ProtoWrapper+CreateMuxedEd25519Param</summary>
    public static class MuxedAccount_ProtoWrapperCreateMuxedEd25519ParamGrpcMarshaller
    {
        // Static constructor to configure type
        static MuxedAccount_ProtoWrapperCreateMuxedEd25519ParamGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.MuxedAccount_ProtoWrapper.CreateMuxedEd25519Param
            if (!model.IsDefined(typeof(Stellar.MuxedAccount_ProtoWrapper.CreateMuxedEd25519Param)))
            {
                var metaType = model.Add(typeof(Stellar.MuxedAccount_ProtoWrapper.CreateMuxedEd25519Param), false);
