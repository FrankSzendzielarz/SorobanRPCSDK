...
{
    /// <summary>Custom marshaller for Stellar.ClaimPredicateEncodeRequest</summary>
    public static class ClaimPredicateEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ClaimPredicateEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ClaimPredicateEncodeRequest
            if (!model.IsDefined(typeof(Stellar.ClaimPredicateEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ClaimPredicateEncodeRequest), false);
