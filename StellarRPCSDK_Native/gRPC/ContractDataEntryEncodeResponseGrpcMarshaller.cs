...
{
    /// <summary>Custom marshaller for Stellar.ContractDataEntryEncodeResponse</summary>
    public static class ContractDataEntryEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ContractDataEntryEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ContractDataEntryEncodeResponse
            if (!model.IsDefined(typeof(Stellar.ContractDataEntryEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ContractDataEntryEncodeResponse), false);
