...
{
    /// <summary>Custom marshaller for Stellar.TransactionPhaseEncodeRequest</summary>
    public static class TransactionPhaseEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static TransactionPhaseEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TransactionPhaseEncodeRequest
            if (!model.IsDefined(typeof(Stellar.TransactionPhaseEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.TransactionPhaseEncodeRequest), false);
