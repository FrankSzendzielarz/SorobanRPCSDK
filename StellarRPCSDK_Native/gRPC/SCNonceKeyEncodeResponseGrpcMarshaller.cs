...
{
    /// <summary>Custom marshaller for Stellar.SCNonceKeyEncodeResponse</summary>
    public static class SCNonceKeyEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SCNonceKeyEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCNonceKeyEncodeResponse
            if (!model.IsDefined(typeof(Stellar.SCNonceKeyEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SCNonceKeyEncodeResponse), false);
