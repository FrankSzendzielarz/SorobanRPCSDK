...
{
    /// <summary>Custom marshaller for Stellar.PriceEncodeResponse</summary>
    public static class PriceEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static PriceEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.PriceEncodeResponse
            if (!model.IsDefined(typeof(Stellar.PriceEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.PriceEncodeResponse), false);
