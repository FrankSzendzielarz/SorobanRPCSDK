...
{
    /// <summary>Custom marshaller for Stellar.LiquidityPoolEntryDecodeRequest</summary>
    public static class LiquidityPoolEntryDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static LiquidityPoolEntryDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.LiquidityPoolEntryDecodeRequest
            if (!model.IsDefined(typeof(Stellar.LiquidityPoolEntryDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.LiquidityPoolEntryDecodeRequest), false);
