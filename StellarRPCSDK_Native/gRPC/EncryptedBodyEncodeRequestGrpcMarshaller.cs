...
{
    /// <summary>Custom marshaller for Stellar.EncryptedBodyEncodeRequest</summary>
    public static class EncryptedBodyEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static EncryptedBodyEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.EncryptedBodyEncodeRequest
            if (!model.IsDefined(typeof(Stellar.EncryptedBodyEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.EncryptedBodyEncodeRequest), false);
