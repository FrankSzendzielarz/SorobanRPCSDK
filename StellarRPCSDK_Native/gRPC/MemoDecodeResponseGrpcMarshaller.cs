...
{
    /// <summary>Custom marshaller for Stellar.MemoDecodeResponse</summary>
    public static class MemoDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static MemoDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.MemoDecodeResponse
            if (!model.IsDefined(typeof(Stellar.MemoDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.MemoDecodeResponse), false);
