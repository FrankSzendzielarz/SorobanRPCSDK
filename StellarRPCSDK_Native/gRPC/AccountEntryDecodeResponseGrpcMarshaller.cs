...
{
    /// <summary>Custom marshaller for Stellar.AccountEntryDecodeResponse</summary>
    public static class AccountEntryDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static AccountEntryDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.AccountEntryDecodeResponse
            if (!model.IsDefined(typeof(Stellar.AccountEntryDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.AccountEntryDecodeResponse), false);
