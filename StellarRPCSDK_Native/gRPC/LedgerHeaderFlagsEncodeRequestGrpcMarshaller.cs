...
{
    /// <summary>Custom marshaller for Stellar.LedgerHeaderFlagsEncodeRequest</summary>
    public static class LedgerHeaderFlagsEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static LedgerHeaderFlagsEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.LedgerHeaderFlagsEncodeRequest
            if (!model.IsDefined(typeof(Stellar.LedgerHeaderFlagsEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.LedgerHeaderFlagsEncodeRequest), false);
