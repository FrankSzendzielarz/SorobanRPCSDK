...
{
    /// <summary>Custom marshaller for Stellar.SignedSurveyRequestMessageEncodeResponse</summary>
    public static class SignedSurveyRequestMessageEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SignedSurveyRequestMessageEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SignedSurveyRequestMessageEncodeResponse
            if (!model.IsDefined(typeof(Stellar.SignedSurveyRequestMessageEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SignedSurveyRequestMessageEncodeResponse), false);
