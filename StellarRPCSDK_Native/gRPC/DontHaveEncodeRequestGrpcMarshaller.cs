...
{
    /// <summary>Custom marshaller for Stellar.DontHaveEncodeRequest</summary>
    public static class DontHaveEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static DontHaveEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.DontHaveEncodeRequest
            if (!model.IsDefined(typeof(Stellar.DontHaveEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.DontHaveEncodeRequest), false);
