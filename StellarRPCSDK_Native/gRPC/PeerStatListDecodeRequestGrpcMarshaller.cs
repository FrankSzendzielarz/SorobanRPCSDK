...
{
    /// <summary>Custom marshaller for Stellar.PeerStatListDecodeRequest</summary>
    public static class PeerStatListDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static PeerStatListDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.PeerStatListDecodeRequest
            if (!model.IsDefined(typeof(Stellar.PeerStatListDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.PeerStatListDecodeRequest), false);
