...
{
    /// <summary>Custom marshaller for Stellar.ColdArchiveBoundaryLeafDecodeRequest</summary>
    public static class ColdArchiveBoundaryLeafDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ColdArchiveBoundaryLeafDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ColdArchiveBoundaryLeafDecodeRequest
            if (!model.IsDefined(typeof(Stellar.ColdArchiveBoundaryLeafDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ColdArchiveBoundaryLeafDecodeRequest), false);
