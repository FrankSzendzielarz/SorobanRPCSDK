...
namespace Stellar.RPC.AOT
{
    ...
    public static class TransactionHistoryEntryextUnioncase_1GrpcMarshaller
    {
        ...
        public static readonly Marshaller<Stellar.TransactionHistoryEntry.extUnion.case_1> case_1Marshaller = Marshallers.Create<Stellar.TransactionHistoryEntry.extUnion.case_1>(
