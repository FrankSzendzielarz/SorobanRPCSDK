...
namespace Stellar.RPC.AOT
{
    ...
    public static class ClaimableBalanceEntryextUnioncase_0GrpcMarshaller
    {
        ...
        public static readonly Marshaller<Stellar.ClaimableBalanceEntry.extUnion.case_0> case_0Marshaller = Marshallers.Create<Stellar.ClaimableBalanceEntry.extUnion.case_0>(
