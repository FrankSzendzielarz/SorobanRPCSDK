...
{
    /// <summary>Custom marshaller for Stellar.SCSpecTypeUDTDecodeRequest</summary>
    public static class SCSpecTypeUDTDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SCSpecTypeUDTDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCSpecTypeUDTDecodeRequest
            if (!model.IsDefined(typeof(Stellar.SCSpecTypeUDTDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SCSpecTypeUDTDecodeRequest), false);
