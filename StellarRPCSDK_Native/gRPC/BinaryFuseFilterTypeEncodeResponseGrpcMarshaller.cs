...
{
    /// <summary>Custom marshaller for Stellar.BinaryFuseFilterTypeEncodeResponse</summary>
    public static class BinaryFuseFilterTypeEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static BinaryFuseFilterTypeEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.BinaryFuseFilterTypeEncodeResponse
            if (!model.IsDefined(typeof(Stellar.BinaryFuseFilterTypeEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.BinaryFuseFilterTypeEncodeResponse), false);
