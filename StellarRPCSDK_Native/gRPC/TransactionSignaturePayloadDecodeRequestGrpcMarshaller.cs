...
{
    /// <summary>Custom marshaller for Stellar.TransactionSignaturePayloadDecodeRequest</summary>
    public static class TransactionSignaturePayloadDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static TransactionSignaturePayloadDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TransactionSignaturePayloadDecodeRequest
            if (!model.IsDefined(typeof(Stellar.TransactionSignaturePayloadDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.TransactionSignaturePayloadDecodeRequest), false);
