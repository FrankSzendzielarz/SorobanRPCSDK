...
{
    /// <summary>Custom marshaller for Stellar.SetOptionsResultCodeDecodeRequest</summary>
    public static class SetOptionsResultCodeDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SetOptionsResultCodeDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SetOptionsResultCodeDecodeRequest
            if (!model.IsDefined(typeof(Stellar.SetOptionsResultCodeDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SetOptionsResultCodeDecodeRequest), false);
