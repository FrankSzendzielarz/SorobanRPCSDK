...
{
    /// <summary>Custom marshaller for Stellar.ClaimableBalanceEntryDecodeRequest</summary>
    public static class ClaimableBalanceEntryDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ClaimableBalanceEntryDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ClaimableBalanceEntryDecodeRequest
            if (!model.IsDefined(typeof(Stellar.ClaimableBalanceEntryDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ClaimableBalanceEntryDecodeRequest), false);
