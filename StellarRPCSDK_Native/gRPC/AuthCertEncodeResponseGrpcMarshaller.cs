...
{
    /// <summary>Custom marshaller for Stellar.AuthCertEncodeResponse</summary>
    public static class AuthCertEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static AuthCertEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.AuthCertEncodeResponse
            if (!model.IsDefined(typeof(Stellar.AuthCertEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.AuthCertEncodeResponse), false);
