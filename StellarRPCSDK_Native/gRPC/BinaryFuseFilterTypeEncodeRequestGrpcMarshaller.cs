...
{
    /// <summary>Custom marshaller for Stellar.BinaryFuseFilterTypeEncodeRequest</summary>
    public static class BinaryFuseFilterTypeEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static BinaryFuseFilterTypeEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.BinaryFuseFilterTypeEncodeRequest
            if (!model.IsDefined(typeof(Stellar.BinaryFuseFilterTypeEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.BinaryFuseFilterTypeEncodeRequest), false);
