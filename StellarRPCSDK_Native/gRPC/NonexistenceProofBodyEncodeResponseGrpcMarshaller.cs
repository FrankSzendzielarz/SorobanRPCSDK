...
{
    /// <summary>Custom marshaller for Stellar.NonexistenceProofBodyEncodeResponse</summary>
    public static class NonexistenceProofBodyEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static NonexistenceProofBodyEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.NonexistenceProofBodyEncodeResponse
            if (!model.IsDefined(typeof(Stellar.NonexistenceProofBodyEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.NonexistenceProofBodyEncodeResponse), false);
