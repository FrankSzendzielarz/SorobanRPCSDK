...
{
    /// <summary>Custom marshaller for Stellar.SponsorshipDescriptorDecodeResponse</summary>
    public static class SponsorshipDescriptorDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SponsorshipDescriptorDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SponsorshipDescriptorDecodeResponse
            if (!model.IsDefined(typeof(Stellar.SponsorshipDescriptorDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SponsorshipDescriptorDecodeResponse), false);
