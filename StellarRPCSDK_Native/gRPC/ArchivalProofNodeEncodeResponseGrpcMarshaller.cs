...
{
    /// <summary>Custom marshaller for Stellar.ArchivalProofNodeEncodeResponse</summary>
    public static class ArchivalProofNodeEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ArchivalProofNodeEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ArchivalProofNodeEncodeResponse
            if (!model.IsDefined(typeof(Stellar.ArchivalProofNodeEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ArchivalProofNodeEncodeResponse), false);
