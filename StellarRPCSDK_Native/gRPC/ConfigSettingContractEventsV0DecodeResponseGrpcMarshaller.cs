...
{
    /// <summary>Custom marshaller for Stellar.ConfigSettingContractEventsV0DecodeResponse</summary>
    public static class ConfigSettingContractEventsV0DecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ConfigSettingContractEventsV0DecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ConfigSettingContractEventsV0DecodeResponse
            if (!model.IsDefined(typeof(Stellar.ConfigSettingContractEventsV0DecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ConfigSettingContractEventsV0DecodeResponse), false);
