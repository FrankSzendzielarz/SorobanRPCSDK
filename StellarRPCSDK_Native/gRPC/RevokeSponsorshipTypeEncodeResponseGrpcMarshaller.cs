...
{
    /// <summary>Custom marshaller for Stellar.RevokeSponsorshipTypeEncodeResponse</summary>
    public static class RevokeSponsorshipTypeEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static RevokeSponsorshipTypeEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.RevokeSponsorshipTypeEncodeResponse
            if (!model.IsDefined(typeof(Stellar.RevokeSponsorshipTypeEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.RevokeSponsorshipTypeEncodeResponse), false);
