...
{
    /// <summary>Custom marshaller for Stellar.ContractDataDurabilityEncodeRequest</summary>
    public static class ContractDataDurabilityEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ContractDataDurabilityEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ContractDataDurabilityEncodeRequest
            if (!model.IsDefined(typeof(Stellar.ContractDataDurabilityEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ContractDataDurabilityEncodeRequest), false);
