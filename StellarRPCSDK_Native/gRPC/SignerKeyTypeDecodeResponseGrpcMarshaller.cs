...
{
    /// <summary>Custom marshaller for Stellar.SignerKeyTypeDecodeResponse</summary>
    public static class SignerKeyTypeDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SignerKeyTypeDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SignerKeyTypeDecodeResponse
            if (!model.IsDefined(typeof(Stellar.SignerKeyTypeDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SignerKeyTypeDecodeResponse), false);
