...
{
    /// <summary>Custom marshaller for Stellar.ArchivalProofTypeEncodeRequest</summary>
    public static class ArchivalProofTypeEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ArchivalProofTypeEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ArchivalProofTypeEncodeRequest
            if (!model.IsDefined(typeof(Stellar.ArchivalProofTypeEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ArchivalProofTypeEncodeRequest), false);
