...
{
    /// <summary>Custom marshaller for Stellar.SCMapEncodeRequest</summary>
    public static class SCMapEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SCMapEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCMapEncodeRequest
            if (!model.IsDefined(typeof(Stellar.SCMapEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SCMapEncodeRequest), false);
