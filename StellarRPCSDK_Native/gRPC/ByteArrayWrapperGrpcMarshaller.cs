...
{
    /// <summary>Custom marshaller for Stellar.ByteArrayWrapper</summary>
    public static class ByteArrayWrapperGrpcMarshaller
    {
        // Static constructor to configure type
        static ByteArrayWrapperGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ByteArrayWrapper
            if (!model.IsDefined(typeof(Stellar.ByteArrayWrapper)))
            {
                var metaType = model.Add(typeof(Stellar.ByteArrayWrapper), false);
