...
{
    /// <summary>Custom marshaller for Stellar.ContractIDPreimageTypeDecodeRequest</summary>
    public static class ContractIDPreimageTypeDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ContractIDPreimageTypeDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ContractIDPreimageTypeDecodeRequest
            if (!model.IsDefined(typeof(Stellar.ContractIDPreimageTypeDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ContractIDPreimageTypeDecodeRequest), false);
