...
{
    /// <summary>Custom marshaller for Stellar.LiquidityPoolDepositOpDecodeResponse</summary>
    public static class LiquidityPoolDepositOpDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static LiquidityPoolDepositOpDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.LiquidityPoolDepositOpDecodeResponse
            if (!model.IsDefined(typeof(Stellar.LiquidityPoolDepositOpDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.LiquidityPoolDepositOpDecodeResponse), false);
