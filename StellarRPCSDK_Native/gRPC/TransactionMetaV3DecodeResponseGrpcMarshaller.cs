...
{
    /// <summary>Custom marshaller for Stellar.TransactionMetaV3DecodeResponse</summary>
    public static class TransactionMetaV3DecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static TransactionMetaV3DecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TransactionMetaV3DecodeResponse
            if (!model.IsDefined(typeof(Stellar.TransactionMetaV3DecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.TransactionMetaV3DecodeResponse), false);
