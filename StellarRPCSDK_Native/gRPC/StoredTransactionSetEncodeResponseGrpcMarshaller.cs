...
{
    /// <summary>Custom marshaller for Stellar.StoredTransactionSetEncodeResponse</summary>
    public static class StoredTransactionSetEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static StoredTransactionSetEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.StoredTransactionSetEncodeResponse
            if (!model.IsDefined(typeof(Stellar.StoredTransactionSetEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.StoredTransactionSetEncodeResponse), false);
