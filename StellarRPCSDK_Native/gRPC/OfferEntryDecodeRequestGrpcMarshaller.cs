...
{
    /// <summary>Custom marshaller for Stellar.OfferEntryDecodeRequest</summary>
    public static class OfferEntryDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static OfferEntryDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.OfferEntryDecodeRequest
            if (!model.IsDefined(typeof(Stellar.OfferEntryDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.OfferEntryDecodeRequest), false);
