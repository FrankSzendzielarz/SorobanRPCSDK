...
{
    /// <summary>Custom marshaller for Stellar.CryptoKeyTypeDecodeRequest</summary>
    public static class CryptoKeyTypeDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static CryptoKeyTypeDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.CryptoKeyTypeDecodeRequest
            if (!model.IsDefined(typeof(Stellar.CryptoKeyTypeDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.CryptoKeyTypeDecodeRequest), false);
