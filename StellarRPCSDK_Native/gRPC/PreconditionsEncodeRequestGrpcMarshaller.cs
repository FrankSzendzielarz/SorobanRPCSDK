...
{
    /// <summary>Custom marshaller for Stellar.PreconditionsEncodeRequest</summary>
    public static class PreconditionsEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static PreconditionsEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.PreconditionsEncodeRequest
            if (!model.IsDefined(typeof(Stellar.PreconditionsEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.PreconditionsEncodeRequest), false);
