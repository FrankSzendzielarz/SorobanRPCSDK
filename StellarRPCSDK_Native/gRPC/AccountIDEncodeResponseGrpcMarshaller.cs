...
{
    /// <summary>Custom marshaller for Stellar.AccountIDEncodeResponse</summary>
    public static class AccountIDEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static AccountIDEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.AccountIDEncodeResponse
            if (!model.IsDefined(typeof(Stellar.AccountIDEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.AccountIDEncodeResponse), false);
