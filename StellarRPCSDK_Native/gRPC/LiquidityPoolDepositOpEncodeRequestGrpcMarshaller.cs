...
{
    /// <summary>Custom marshaller for Stellar.LiquidityPoolDepositOpEncodeRequest</summary>
    public static class LiquidityPoolDepositOpEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static LiquidityPoolDepositOpEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.LiquidityPoolDepositOpEncodeRequest
            if (!model.IsDefined(typeof(Stellar.LiquidityPoolDepositOpEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.LiquidityPoolDepositOpEncodeRequest), false);
