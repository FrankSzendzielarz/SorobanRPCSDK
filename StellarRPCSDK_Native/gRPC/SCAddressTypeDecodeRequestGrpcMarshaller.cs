...
{
    /// <summary>Custom marshaller for Stellar.SCAddressTypeDecodeRequest</summary>
    public static class SCAddressTypeDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SCAddressTypeDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCAddressTypeDecodeRequest
            if (!model.IsDefined(typeof(Stellar.SCAddressTypeDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SCAddressTypeDecodeRequest), false);
