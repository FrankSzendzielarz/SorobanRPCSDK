...
{
    /// <summary>Custom marshaller for Stellar.Transaction_ProtoWrapper+IsSorobanParam</summary>
    public static class Transaction_ProtoWrapperIsSorobanParamGrpcMarshaller
    {
        // Static constructor to configure type
        static Transaction_ProtoWrapperIsSorobanParamGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.Transaction_ProtoWrapper.IsSorobanParam
            if (!model.IsDefined(typeof(Stellar.Transaction_ProtoWrapper.IsSorobanParam)))
            {
                var metaType = model.Add(typeof(Stellar.Transaction_ProtoWrapper.IsSorobanParam), false);
