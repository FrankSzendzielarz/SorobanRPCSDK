...
{
    /// <summary>Custom marshaller for Stellar.InvokeHostFunctionSuccessPreImageDecodeRequest</summary>
    public static class InvokeHostFunctionSuccessPreImageDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static InvokeHostFunctionSuccessPreImageDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.InvokeHostFunctionSuccessPreImageDecodeRequest
            if (!model.IsDefined(typeof(Stellar.InvokeHostFunctionSuccessPreImageDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.InvokeHostFunctionSuccessPreImageDecodeRequest), false);
