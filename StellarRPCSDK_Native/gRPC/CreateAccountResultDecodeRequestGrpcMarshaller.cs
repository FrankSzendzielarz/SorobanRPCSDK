...
{
    /// <summary>Custom marshaller for Stellar.CreateAccountResultDecodeRequest</summary>
    public static class CreateAccountResultDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static CreateAccountResultDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.CreateAccountResultDecodeRequest
            if (!model.IsDefined(typeof(Stellar.CreateAccountResultDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.CreateAccountResultDecodeRequest), false);
