...
{
    /// <summary>Custom marshaller for Stellar.OperationEncodeResponse</summary>
    public static class OperationEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static OperationEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.OperationEncodeResponse
            if (!model.IsDefined(typeof(Stellar.OperationEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.OperationEncodeResponse), false);
