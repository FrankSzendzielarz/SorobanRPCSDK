...
{
    /// <summary>Custom marshaller for Stellar.ClaimPredicateEncodeResponse</summary>
    public static class ClaimPredicateEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ClaimPredicateEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ClaimPredicateEncodeResponse
            if (!model.IsDefined(typeof(Stellar.ClaimPredicateEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ClaimPredicateEncodeResponse), false);
