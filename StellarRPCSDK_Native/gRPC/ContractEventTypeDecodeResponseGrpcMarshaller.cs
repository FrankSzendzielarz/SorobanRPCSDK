...
{
    /// <summary>Custom marshaller for Stellar.ContractEventTypeDecodeResponse</summary>
    public static class ContractEventTypeDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ContractEventTypeDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ContractEventTypeDecodeResponse
            if (!model.IsDefined(typeof(Stellar.ContractEventTypeDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ContractEventTypeDecodeResponse), false);
