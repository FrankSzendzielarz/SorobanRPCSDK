...
{
    /// <summary>Custom marshaller for Stellar.AssetCode4DecodeRequest</summary>
    public static class AssetCode4DecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static AssetCode4DecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.AssetCode4DecodeRequest
            if (!model.IsDefined(typeof(Stellar.AssetCode4DecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.AssetCode4DecodeRequest), false);
