...
{
    /// <summary>Custom marshaller for Stellar.AlphaNum12EncodeResponse</summary>
    public static class AlphaNum12EncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static AlphaNum12EncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.AlphaNum12EncodeResponse
            if (!model.IsDefined(typeof(Stellar.AlphaNum12EncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.AlphaNum12EncodeResponse), false);
