...
{
    /// <summary>Custom marshaller for Stellar.TransactionResultCodeDecodeRequest</summary>
    public static class TransactionResultCodeDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static TransactionResultCodeDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TransactionResultCodeDecodeRequest
            if (!model.IsDefined(typeof(Stellar.TransactionResultCodeDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.TransactionResultCodeDecodeRequest), false);
