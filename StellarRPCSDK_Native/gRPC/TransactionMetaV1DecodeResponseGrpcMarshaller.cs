...
{
    /// <summary>Custom marshaller for Stellar.TransactionMetaV1DecodeResponse</summary>
    public static class TransactionMetaV1DecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static TransactionMetaV1DecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TransactionMetaV1DecodeResponse
            if (!model.IsDefined(typeof(Stellar.TransactionMetaV1DecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.TransactionMetaV1DecodeResponse), false);
