...
{
    /// <summary>Custom marshaller for Stellar.AuthenticatedMessageDecodeResponse</summary>
    public static class AuthenticatedMessageDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static AuthenticatedMessageDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.AuthenticatedMessageDecodeResponse
            if (!model.IsDefined(typeof(Stellar.AuthenticatedMessageDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.AuthenticatedMessageDecodeResponse), false);
