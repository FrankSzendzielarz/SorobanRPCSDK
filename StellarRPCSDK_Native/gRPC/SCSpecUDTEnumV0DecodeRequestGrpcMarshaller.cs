...
{
    /// <summary>Custom marshaller for Stellar.SCSpecUDTEnumV0DecodeRequest</summary>
    public static class SCSpecUDTEnumV0DecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SCSpecUDTEnumV0DecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCSpecUDTEnumV0DecodeRequest
            if (!model.IsDefined(typeof(Stellar.SCSpecUDTEnumV0DecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SCSpecUDTEnumV0DecodeRequest), false);
