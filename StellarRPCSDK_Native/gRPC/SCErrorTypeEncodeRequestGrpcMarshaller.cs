...
{
    /// <summary>Custom marshaller for Stellar.SCErrorTypeEncodeRequest</summary>
    public static class SCErrorTypeEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SCErrorTypeEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCErrorTypeEncodeRequest
            if (!model.IsDefined(typeof(Stellar.SCErrorTypeEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SCErrorTypeEncodeRequest), false);
