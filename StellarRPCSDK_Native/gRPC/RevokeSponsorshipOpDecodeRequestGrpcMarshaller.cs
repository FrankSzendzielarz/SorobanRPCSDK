...
{
    /// <summary>Custom marshaller for Stellar.RevokeSponsorshipOpDecodeRequest</summary>
    public static class RevokeSponsorshipOpDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static RevokeSponsorshipOpDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.RevokeSponsorshipOpDecodeRequest
            if (!model.IsDefined(typeof(Stellar.RevokeSponsorshipOpDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.RevokeSponsorshipOpDecodeRequest), false);
