...
{
    /// <summary>Custom marshaller for Stellar.SCPQuorumSetEncodeResponse</summary>
    public static class SCPQuorumSetEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SCPQuorumSetEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCPQuorumSetEncodeResponse
            if (!model.IsDefined(typeof(Stellar.SCPQuorumSetEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SCPQuorumSetEncodeResponse), false);
