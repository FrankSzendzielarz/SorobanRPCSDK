...
{
    /// <summary>Custom marshaller for Stellar.EncryptedBodyDecodeRequest</summary>
    public static class EncryptedBodyDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static EncryptedBodyDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.EncryptedBodyDecodeRequest
            if (!model.IsDefined(typeof(Stellar.EncryptedBodyDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.EncryptedBodyDecodeRequest), false);
