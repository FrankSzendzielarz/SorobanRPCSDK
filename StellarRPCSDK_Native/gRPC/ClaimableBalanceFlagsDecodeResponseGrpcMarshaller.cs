...
{
    /// <summary>Custom marshaller for Stellar.ClaimableBalanceFlagsDecodeResponse</summary>
    public static class ClaimableBalanceFlagsDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ClaimableBalanceFlagsDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ClaimableBalanceFlagsDecodeResponse
            if (!model.IsDefined(typeof(Stellar.ClaimableBalanceFlagsDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ClaimableBalanceFlagsDecodeResponse), false);
