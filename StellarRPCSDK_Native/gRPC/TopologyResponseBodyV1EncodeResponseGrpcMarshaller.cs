...
{
    /// <summary>Custom marshaller for Stellar.TopologyResponseBodyV1EncodeResponse</summary>
    public static class TopologyResponseBodyV1EncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static TopologyResponseBodyV1EncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TopologyResponseBodyV1EncodeResponse
            if (!model.IsDefined(typeof(Stellar.TopologyResponseBodyV1EncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.TopologyResponseBodyV1EncodeResponse), false);
