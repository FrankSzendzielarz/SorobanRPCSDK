...
{
    /// <summary>Custom marshaller for Stellar.PathPaymentStrictSendOpEncodeRequest</summary>
    public static class PathPaymentStrictSendOpEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static PathPaymentStrictSendOpEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.PathPaymentStrictSendOpEncodeRequest
            if (!model.IsDefined(typeof(Stellar.PathPaymentStrictSendOpEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.PathPaymentStrictSendOpEncodeRequest), false);
