...
{
    /// <summary>Custom marshaller for Stellar.SCSpecEntryKindDecodeResponse</summary>
    public static class SCSpecEntryKindDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SCSpecEntryKindDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCSpecEntryKindDecodeResponse
            if (!model.IsDefined(typeof(Stellar.SCSpecEntryKindDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SCSpecEntryKindDecodeResponse), false);
