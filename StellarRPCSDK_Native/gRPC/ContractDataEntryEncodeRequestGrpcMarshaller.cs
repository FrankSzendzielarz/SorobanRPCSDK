...
{
    /// <summary>Custom marshaller for Stellar.ContractDataEntryEncodeRequest</summary>
    public static class ContractDataEntryEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ContractDataEntryEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ContractDataEntryEncodeRequest
            if (!model.IsDefined(typeof(Stellar.ContractDataEntryEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ContractDataEntryEncodeRequest), false);
