...
{
    /// <summary>Custom marshaller for Stellar.ThresholdIndexesEncodeRequest</summary>
    public static class ThresholdIndexesEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ThresholdIndexesEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ThresholdIndexesEncodeRequest
            if (!model.IsDefined(typeof(Stellar.ThresholdIndexesEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ThresholdIndexesEncodeRequest), false);
