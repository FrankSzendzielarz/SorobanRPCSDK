...
{
    /// <summary>Custom marshaller for Stellar.UInt256PartsEncodeRequest</summary>
    public static class UInt256PartsEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static UInt256PartsEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.UInt256PartsEncodeRequest
            if (!model.IsDefined(typeof(Stellar.UInt256PartsEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.UInt256PartsEncodeRequest), false);
