...
{
    /// <summary>Custom marshaller for Stellar.TransactionResultSetEncodeRequest</summary>
    public static class TransactionResultSetEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static TransactionResultSetEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TransactionResultSetEncodeRequest
            if (!model.IsDefined(typeof(Stellar.TransactionResultSetEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.TransactionResultSetEncodeRequest), false);
