...
namespace Stellar.RPC.AOT
{
    ...
    public static class ClaimableBalanceEntryextUnioncase_1GrpcMarshaller
    {
        ...
        public static readonly Marshaller<Stellar.ClaimableBalanceEntry.extUnion.case_1> case_1Marshaller = Marshallers.Create<Stellar.ClaimableBalanceEntry.extUnion.case_1>(
