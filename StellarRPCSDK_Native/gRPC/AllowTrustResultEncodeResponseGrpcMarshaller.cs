...
{
    /// <summary>Custom marshaller for Stellar.AllowTrustResultEncodeResponse</summary>
    public static class AllowTrustResultEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static AllowTrustResultEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.AllowTrustResultEncodeResponse
            if (!model.IsDefined(typeof(Stellar.AllowTrustResultEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.AllowTrustResultEncodeResponse), false);
