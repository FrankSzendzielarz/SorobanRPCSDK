...
{
    /// <summary>Custom marshaller for Stellar.ExtendFootprintTTLResultEncodeResponse</summary>
    public static class ExtendFootprintTTLResultEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ExtendFootprintTTLResultEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ExtendFootprintTTLResultEncodeResponse
            if (!model.IsDefined(typeof(Stellar.ExtendFootprintTTLResultEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ExtendFootprintTTLResultEncodeResponse), false);
