...
{
    /// <summary>Custom marshaller for Stellar.LedgerFootprintDecodeResponse</summary>
    public static class LedgerFootprintDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static LedgerFootprintDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.LedgerFootprintDecodeResponse
            if (!model.IsDefined(typeof(Stellar.LedgerFootprintDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.LedgerFootprintDecodeResponse), false);
