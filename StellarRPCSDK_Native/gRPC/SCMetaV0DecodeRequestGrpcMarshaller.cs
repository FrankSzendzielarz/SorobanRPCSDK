...
{
    /// <summary>Custom marshaller for Stellar.SCMetaV0DecodeRequest</summary>
    public static class SCMetaV0DecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SCMetaV0DecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCMetaV0DecodeRequest
            if (!model.IsDefined(typeof(Stellar.SCMetaV0DecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SCMetaV0DecodeRequest), false);
