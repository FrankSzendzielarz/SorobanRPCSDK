...
{
    /// <summary>Custom marshaller for Stellar.AuthenticatedMessageEncodeResponse</summary>
    public static class AuthenticatedMessageEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static AuthenticatedMessageEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.AuthenticatedMessageEncodeResponse
            if (!model.IsDefined(typeof(Stellar.AuthenticatedMessageEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.AuthenticatedMessageEncodeResponse), false);
