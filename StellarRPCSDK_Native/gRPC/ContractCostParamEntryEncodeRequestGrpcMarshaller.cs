...
{
    /// <summary>Custom marshaller for Stellar.ContractCostParamEntryEncodeRequest</summary>
    public static class ContractCostParamEntryEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ContractCostParamEntryEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ContractCostParamEntryEncodeRequest
            if (!model.IsDefined(typeof(Stellar.ContractCostParamEntryEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ContractCostParamEntryEncodeRequest), false);
