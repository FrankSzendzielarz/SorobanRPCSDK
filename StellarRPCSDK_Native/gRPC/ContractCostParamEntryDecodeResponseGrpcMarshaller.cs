...
{
    /// <summary>Custom marshaller for Stellar.ContractCostParamEntryDecodeResponse</summary>
    public static class ContractCostParamEntryDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ContractCostParamEntryDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ContractCostParamEntryDecodeResponse
            if (!model.IsDefined(typeof(Stellar.ContractCostParamEntryDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ContractCostParamEntryDecodeResponse), false);
