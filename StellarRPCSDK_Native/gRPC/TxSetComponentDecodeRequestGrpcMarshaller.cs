...
{
    /// <summary>Custom marshaller for Stellar.TxSetComponentDecodeRequest</summary>
    public static class TxSetComponentDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static TxSetComponentDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TxSetComponentDecodeRequest
            if (!model.IsDefined(typeof(Stellar.TxSetComponentDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.TxSetComponentDecodeRequest), false);
