...
{
    /// <summary>Custom marshaller for Stellar.Curve25519SecretDecodeRequest</summary>
    public static class Curve25519SecretDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static Curve25519SecretDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.Curve25519SecretDecodeRequest
            if (!model.IsDefined(typeof(Stellar.Curve25519SecretDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.Curve25519SecretDecodeRequest), false);
