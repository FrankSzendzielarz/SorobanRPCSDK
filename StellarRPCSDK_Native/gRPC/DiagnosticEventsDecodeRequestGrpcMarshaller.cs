...
{
    /// <summary>Custom marshaller for Stellar.DiagnosticEventsDecodeRequest</summary>
    public static class DiagnosticEventsDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static DiagnosticEventsDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.DiagnosticEventsDecodeRequest
            if (!model.IsDefined(typeof(Stellar.DiagnosticEventsDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.DiagnosticEventsDecodeRequest), false);
