...
{
    /// <summary>Custom marshaller for Stellar.SetOptionsResultDecodeRequest</summary>
    public static class SetOptionsResultDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SetOptionsResultDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SetOptionsResultDecodeRequest
            if (!model.IsDefined(typeof(Stellar.SetOptionsResultDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SetOptionsResultDecodeRequest), false);
