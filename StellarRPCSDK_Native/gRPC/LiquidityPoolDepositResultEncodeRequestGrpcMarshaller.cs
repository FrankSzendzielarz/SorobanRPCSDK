...
{
    /// <summary>Custom marshaller for Stellar.LiquidityPoolDepositResultEncodeRequest</summary>
    public static class LiquidityPoolDepositResultEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static LiquidityPoolDepositResultEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.LiquidityPoolDepositResultEncodeRequest
            if (!model.IsDefined(typeof(Stellar.LiquidityPoolDepositResultEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.LiquidityPoolDepositResultEncodeRequest), false);
