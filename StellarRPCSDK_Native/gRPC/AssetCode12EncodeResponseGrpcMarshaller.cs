...
{
    /// <summary>Custom marshaller for Stellar.AssetCode12EncodeResponse</summary>
    public static class AssetCode12EncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static AssetCode12EncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.AssetCode12EncodeResponse
            if (!model.IsDefined(typeof(Stellar.AssetCode12EncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.AssetCode12EncodeResponse), false);
