...
{
    /// <summary>Custom marshaller for Stellar.LedgerCloseMetaEncodeResponse</summary>
    public static class LedgerCloseMetaEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static LedgerCloseMetaEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.LedgerCloseMetaEncodeResponse
            if (!model.IsDefined(typeof(Stellar.LedgerCloseMetaEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.LedgerCloseMetaEncodeResponse), false);
