...
{
    /// <summary>Custom marshaller for Stellar.SCSpecTypeBytesNDecodeResponse</summary>
    public static class SCSpecTypeBytesNDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SCSpecTypeBytesNDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCSpecTypeBytesNDecodeResponse
            if (!model.IsDefined(typeof(Stellar.SCSpecTypeBytesNDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SCSpecTypeBytesNDecodeResponse), false);
