...
{
    /// <summary>Custom marshaller for Stellar.TransactionResultSetDecodeRequest</summary>
    public static class TransactionResultSetDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static TransactionResultSetDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TransactionResultSetDecodeRequest
            if (!model.IsDefined(typeof(Stellar.TransactionResultSetDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.TransactionResultSetDecodeRequest), false);
