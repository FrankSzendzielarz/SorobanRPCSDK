...
{
    /// <summary>Custom marshaller for Stellar.PublicKeyEncodeRequest</summary>
    public static class PublicKeyEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static PublicKeyEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.PublicKeyEncodeRequest
            if (!model.IsDefined(typeof(Stellar.PublicKeyEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.PublicKeyEncodeRequest), false);
