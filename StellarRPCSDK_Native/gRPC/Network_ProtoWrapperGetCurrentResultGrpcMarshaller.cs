...
{
    /// <summary>Custom marshaller for Stellar.Network_ProtoWrapper+GetCurrentResult</summary>
    public static class Network_ProtoWrapperGetCurrentResultGrpcMarshaller
    {
        // Static constructor to configure type
        static Network_ProtoWrapperGetCurrentResultGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.Network_ProtoWrapper.GetCurrentResult
            if (!model.IsDefined(typeof(Stellar.Network_ProtoWrapper.GetCurrentResult)))
            {
                var metaType = model.Add(typeof(Stellar.Network_ProtoWrapper.GetCurrentResult), false);
