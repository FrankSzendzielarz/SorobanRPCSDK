...
{
    /// <summary>Custom marshaller for Stellar.SCSymbolDecodeRequest</summary>
    public static class SCSymbolDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SCSymbolDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCSymbolDecodeRequest
            if (!model.IsDefined(typeof(Stellar.SCSymbolDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SCSymbolDecodeRequest), false);
