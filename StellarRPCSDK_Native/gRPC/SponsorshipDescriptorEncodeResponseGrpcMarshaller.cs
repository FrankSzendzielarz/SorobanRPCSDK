...
{
    /// <summary>Custom marshaller for Stellar.SponsorshipDescriptorEncodeResponse</summary>
    public static class SponsorshipDescriptorEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SponsorshipDescriptorEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SponsorshipDescriptorEncodeResponse
            if (!model.IsDefined(typeof(Stellar.SponsorshipDescriptorEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SponsorshipDescriptorEncodeResponse), false);
