...
{
    /// <summary>Custom marshaller for Stellar.SCSymbolDecodeResponse</summary>
    public static class SCSymbolDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SCSymbolDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCSymbolDecodeResponse
            if (!model.IsDefined(typeof(Stellar.SCSymbolDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SCSymbolDecodeResponse), false);
