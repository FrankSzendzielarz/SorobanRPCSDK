...
{
    /// <summary>Custom marshaller for Stellar.TrustLineEntryExtensionV2EncodeResponse</summary>
    public static class TrustLineEntryExtensionV2EncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static TrustLineEntryExtensionV2EncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TrustLineEntryExtensionV2EncodeResponse
            if (!model.IsDefined(typeof(Stellar.TrustLineEntryExtensionV2EncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.TrustLineEntryExtensionV2EncodeResponse), false);
