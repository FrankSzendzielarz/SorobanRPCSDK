...
{
    /// <summary>Custom marshaller for Stellar.ConfigUpgradeSetEncodeResponse</summary>
    public static class ConfigUpgradeSetEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ConfigUpgradeSetEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ConfigUpgradeSetEncodeResponse
            if (!model.IsDefined(typeof(Stellar.ConfigUpgradeSetEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ConfigUpgradeSetEncodeResponse), false);
