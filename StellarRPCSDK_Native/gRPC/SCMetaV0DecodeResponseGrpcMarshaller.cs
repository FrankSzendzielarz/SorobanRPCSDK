...
{
    /// <summary>Custom marshaller for Stellar.SCMetaV0DecodeResponse</summary>
    public static class SCMetaV0DecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SCMetaV0DecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCMetaV0DecodeResponse
            if (!model.IsDefined(typeof(Stellar.SCMetaV0DecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SCMetaV0DecodeResponse), false);
