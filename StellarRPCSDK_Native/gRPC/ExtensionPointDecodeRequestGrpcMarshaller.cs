...
{
    /// <summary>Custom marshaller for Stellar.ExtensionPointDecodeRequest</summary>
    public static class ExtensionPointDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ExtensionPointDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ExtensionPointDecodeRequest
            if (!model.IsDefined(typeof(Stellar.ExtensionPointDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ExtensionPointDecodeRequest), false);
