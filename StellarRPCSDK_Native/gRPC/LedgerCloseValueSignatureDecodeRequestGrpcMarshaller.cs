...
{
    /// <summary>Custom marshaller for Stellar.LedgerCloseValueSignatureDecodeRequest</summary>
    public static class LedgerCloseValueSignatureDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static LedgerCloseValueSignatureDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.LedgerCloseValueSignatureDecodeRequest
            if (!model.IsDefined(typeof(Stellar.LedgerCloseValueSignatureDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.LedgerCloseValueSignatureDecodeRequest), false);
