...
{
    /// <summary>Custom marshaller for Stellar.AllowTrustOpDecodeResponse</summary>
    public static class AllowTrustOpDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static AllowTrustOpDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.AllowTrustOpDecodeResponse
            if (!model.IsDefined(typeof(Stellar.AllowTrustOpDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.AllowTrustOpDecodeResponse), false);
