...
{
    /// <summary>Custom marshaller for Stellar.InnerTransactionResultPairDecodeRequest</summary>
    public static class InnerTransactionResultPairDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static InnerTransactionResultPairDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.InnerTransactionResultPairDecodeRequest
            if (!model.IsDefined(typeof(Stellar.InnerTransactionResultPairDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.InnerTransactionResultPairDecodeRequest), false);
