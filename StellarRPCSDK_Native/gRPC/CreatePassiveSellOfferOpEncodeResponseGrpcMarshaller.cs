...
{
    /// <summary>Custom marshaller for Stellar.CreatePassiveSellOfferOpEncodeResponse</summary>
    public static class CreatePassiveSellOfferOpEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static CreatePassiveSellOfferOpEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.CreatePassiveSellOfferOpEncodeResponse
            if (!model.IsDefined(typeof(Stellar.CreatePassiveSellOfferOpEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.CreatePassiveSellOfferOpEncodeResponse), false);
