...
{
    /// <summary>Custom marshaller for Stellar.SponsorshipDescriptorDecodeRequest</summary>
    public static class SponsorshipDescriptorDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SponsorshipDescriptorDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SponsorshipDescriptorDecodeRequest
            if (!model.IsDefined(typeof(Stellar.SponsorshipDescriptorDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SponsorshipDescriptorDecodeRequest), false);
