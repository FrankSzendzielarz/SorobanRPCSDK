...
{
    /// <summary>Custom marshaller for Stellar.BumpSequenceResultDecodeRequest</summary>
    public static class BumpSequenceResultDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static BumpSequenceResultDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.BumpSequenceResultDecodeRequest
            if (!model.IsDefined(typeof(Stellar.BumpSequenceResultDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.BumpSequenceResultDecodeRequest), false);
