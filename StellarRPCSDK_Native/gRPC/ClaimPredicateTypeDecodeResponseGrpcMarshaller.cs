...
{
    /// <summary>Custom marshaller for Stellar.ClaimPredicateTypeDecodeResponse</summary>
    public static class ClaimPredicateTypeDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ClaimPredicateTypeDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ClaimPredicateTypeDecodeResponse
            if (!model.IsDefined(typeof(Stellar.ClaimPredicateTypeDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ClaimPredicateTypeDecodeResponse), false);
