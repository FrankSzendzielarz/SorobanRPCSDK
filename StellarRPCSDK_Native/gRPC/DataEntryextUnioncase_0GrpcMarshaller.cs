...
namespace Stellar.RPC.AOT
{
    ...
    public static class DataEntryextUnioncase_0GrpcMarshaller
    {
        ...
        /// <summary>Marshaller for Stellar.DataEntry+extUnion+case_0</summary>
        public static readonly Marshaller<Stellar.DataEntry.extUnion.case_0> DataEntry_extUnion_case_0Marshaller = Marshallers.Create<Stellar.DataEntry.extUnion.case_0>(
