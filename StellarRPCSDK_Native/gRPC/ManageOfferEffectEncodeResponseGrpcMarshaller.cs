...
{
    /// <summary>Custom marshaller for Stellar.ManageOfferEffectEncodeResponse</summary>
    public static class ManageOfferEffectEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ManageOfferEffectEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ManageOfferEffectEncodeResponse
            if (!model.IsDefined(typeof(Stellar.ManageOfferEffectEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ManageOfferEffectEncodeResponse), false);
