...
{
    /// <summary>Custom marshaller for Stellar.HashDecodeResponse</summary>
    public static class HashDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static HashDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.HashDecodeResponse
            if (!model.IsDefined(typeof(Stellar.HashDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.HashDecodeResponse), false);
