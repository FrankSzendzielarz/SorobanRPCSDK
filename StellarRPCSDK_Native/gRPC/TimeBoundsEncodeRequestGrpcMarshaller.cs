...
{
    /// <summary>Custom marshaller for Stellar.TimeBoundsEncodeRequest</summary>
    public static class TimeBoundsEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static TimeBoundsEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TimeBoundsEncodeRequest
            if (!model.IsDefined(typeof(Stellar.TimeBoundsEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.TimeBoundsEncodeRequest), false);
