...
{
    /// <summary>Custom marshaller for Stellar.ManageSellOfferOpEncodeResponse</summary>
    public static class ManageSellOfferOpEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ManageSellOfferOpEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ManageSellOfferOpEncodeResponse
            if (!model.IsDefined(typeof(Stellar.ManageSellOfferOpEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ManageSellOfferOpEncodeResponse), false);
