...
{
    /// <summary>Custom marshaller for Stellar.AllowTrustOpDecodeRequest</summary>
    public static class AllowTrustOpDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static AllowTrustOpDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.AllowTrustOpDecodeRequest
            if (!model.IsDefined(typeof(Stellar.AllowTrustOpDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.AllowTrustOpDecodeRequest), false);
