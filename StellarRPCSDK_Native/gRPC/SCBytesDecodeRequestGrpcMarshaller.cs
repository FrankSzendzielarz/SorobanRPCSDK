...
{
    /// <summary>Custom marshaller for Stellar.SCBytesDecodeRequest</summary>
    public static class SCBytesDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SCBytesDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCBytesDecodeRequest
            if (!model.IsDefined(typeof(Stellar.SCBytesDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SCBytesDecodeRequest), false);
