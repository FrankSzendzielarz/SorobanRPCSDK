...
namespace Stellar.RPC.AOT
{
    ...
    public static class AccountEntryExtensionV1extUnioncase_0GrpcMarshaller
    {
        ...
        public static readonly Marshaller<Stellar.AccountEntryExtensionV1.extUnion.case_0> case_0Marshaller = Marshallers.Create<Stellar.AccountEntryExtensionV1.extUnion.case_0>(
