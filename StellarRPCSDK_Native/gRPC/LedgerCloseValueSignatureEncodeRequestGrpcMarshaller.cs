...
{
    /// <summary>Custom marshaller for Stellar.LedgerCloseValueSignatureEncodeRequest</summary>
    public static class LedgerCloseValueSignatureEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static LedgerCloseValueSignatureEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.LedgerCloseValueSignatureEncodeRequest
            if (!model.IsDefined(typeof(Stellar.LedgerCloseValueSignatureEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.LedgerCloseValueSignatureEncodeRequest), false);
