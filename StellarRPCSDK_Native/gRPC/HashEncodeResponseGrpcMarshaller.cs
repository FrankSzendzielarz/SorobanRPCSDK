...
{
    /// <summary>Custom marshaller for Stellar.HashEncodeResponse</summary>
    public static class HashEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static HashEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.HashEncodeResponse
            if (!model.IsDefined(typeof(Stellar.HashEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.HashEncodeResponse), false);
