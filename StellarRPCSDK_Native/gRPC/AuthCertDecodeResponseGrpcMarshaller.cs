...
{
    /// <summary>Custom marshaller for Stellar.AuthCertDecodeResponse</summary>
    public static class AuthCertDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static AuthCertDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.AuthCertDecodeResponse
            if (!model.IsDefined(typeof(Stellar.AuthCertDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.AuthCertDecodeResponse), false);
