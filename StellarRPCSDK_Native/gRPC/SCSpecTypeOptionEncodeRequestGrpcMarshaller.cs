...
{
    /// <summary>Custom marshaller for Stellar.SCSpecTypeOptionEncodeRequest</summary>
    public static class SCSpecTypeOptionEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SCSpecTypeOptionEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCSpecTypeOptionEncodeRequest
            if (!model.IsDefined(typeof(Stellar.SCSpecTypeOptionEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SCSpecTypeOptionEncodeRequest), false);
