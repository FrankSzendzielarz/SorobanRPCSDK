...
{
    /// <summary>Custom marshaller for Stellar.SurveyRequestMessageEncodeRequest</summary>
    public static class SurveyRequestMessageEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SurveyRequestMessageEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SurveyRequestMessageEncodeRequest
            if (!model.IsDefined(typeof(Stellar.SurveyRequestMessageEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SurveyRequestMessageEncodeRequest), false);
