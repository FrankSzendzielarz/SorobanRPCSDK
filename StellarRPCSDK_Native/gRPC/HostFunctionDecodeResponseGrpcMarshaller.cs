...
{
    /// <summary>Custom marshaller for Stellar.HostFunctionDecodeResponse</summary>
    public static class HostFunctionDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static HostFunctionDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.HostFunctionDecodeResponse
            if (!model.IsDefined(typeof(Stellar.HostFunctionDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.HostFunctionDecodeResponse), false);
