...
{
    /// <summary>Custom marshaller for Stellar.ChangeTrustResultCodeEncodeRequest</summary>
    public static class ChangeTrustResultCodeEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ChangeTrustResultCodeEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ChangeTrustResultCodeEncodeRequest
            if (!model.IsDefined(typeof(Stellar.ChangeTrustResultCodeEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ChangeTrustResultCodeEncodeRequest), false);
