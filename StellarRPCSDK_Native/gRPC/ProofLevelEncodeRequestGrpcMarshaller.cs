...
{
    /// <summary>Custom marshaller for Stellar.ProofLevelEncodeRequest</summary>
    public static class ProofLevelEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ProofLevelEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ProofLevelEncodeRequest
            if (!model.IsDefined(typeof(Stellar.ProofLevelEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ProofLevelEncodeRequest), false);
