...
{
    /// <summary>Custom marshaller for Stellar.ClawbackClaimableBalanceOpEncodeResponse</summary>
    public static class ClawbackClaimableBalanceOpEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ClawbackClaimableBalanceOpEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ClawbackClaimableBalanceOpEncodeResponse
            if (!model.IsDefined(typeof(Stellar.ClawbackClaimableBalanceOpEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ClawbackClaimableBalanceOpEncodeResponse), false);
