...
{
    /// <summary>Custom marshaller for Stellar.Int128PartsEncodeResponse</summary>
    public static class Int128PartsEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static Int128PartsEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.Int128PartsEncodeResponse
            if (!model.IsDefined(typeof(Stellar.Int128PartsEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.Int128PartsEncodeResponse), false);
