...
{
    /// <summary>Custom marshaller for Stellar.SCStringEncodeRequest</summary>
    public static class SCStringEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SCStringEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCStringEncodeRequest
            if (!model.IsDefined(typeof(Stellar.SCStringEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SCStringEncodeRequest), false);
