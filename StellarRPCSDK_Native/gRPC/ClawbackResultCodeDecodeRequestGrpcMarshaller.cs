...
{
    /// <summary>Custom marshaller for Stellar.ClawbackResultCodeDecodeRequest</summary>
    public static class ClawbackResultCodeDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ClawbackResultCodeDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ClawbackResultCodeDecodeRequest
            if (!model.IsDefined(typeof(Stellar.ClawbackResultCodeDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ClawbackResultCodeDecodeRequest), false);
