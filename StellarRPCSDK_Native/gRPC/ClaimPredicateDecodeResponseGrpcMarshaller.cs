...
{
    /// <summary>Custom marshaller for Stellar.ClaimPredicateDecodeResponse</summary>
    public static class ClaimPredicateDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ClaimPredicateDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ClaimPredicateDecodeResponse
            if (!model.IsDefined(typeof(Stellar.ClaimPredicateDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ClaimPredicateDecodeResponse), false);
