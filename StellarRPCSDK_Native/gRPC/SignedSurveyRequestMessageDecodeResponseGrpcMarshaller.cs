...
{
    /// <summary>Custom marshaller for Stellar.SignedSurveyRequestMessageDecodeResponse</summary>
    public static class SignedSurveyRequestMessageDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SignedSurveyRequestMessageDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SignedSurveyRequestMessageDecodeResponse
            if (!model.IsDefined(typeof(Stellar.SignedSurveyRequestMessageDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SignedSurveyRequestMessageDecodeResponse), false);
