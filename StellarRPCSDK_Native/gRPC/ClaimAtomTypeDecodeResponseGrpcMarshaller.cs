...
{
    /// <summary>Custom marshaller for Stellar.ClaimAtomTypeDecodeResponse</summary>
    public static class ClaimAtomTypeDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ClaimAtomTypeDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ClaimAtomTypeDecodeResponse
            if (!model.IsDefined(typeof(Stellar.ClaimAtomTypeDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ClaimAtomTypeDecodeResponse), false);
