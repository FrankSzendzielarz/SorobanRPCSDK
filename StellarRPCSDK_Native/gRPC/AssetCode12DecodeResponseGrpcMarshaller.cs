...
{
    /// <summary>Custom marshaller for Stellar.AssetCode12DecodeResponse</summary>
    public static class AssetCode12DecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static AssetCode12DecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.AssetCode12DecodeResponse
            if (!model.IsDefined(typeof(Stellar.AssetCode12DecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.AssetCode12DecodeResponse), false);
