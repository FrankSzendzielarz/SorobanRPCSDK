...
{
    /// <summary>Custom marshaller for Stellar.FeeBumpTransactionDecodeRequest</summary>
    public static class FeeBumpTransactionDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static FeeBumpTransactionDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.FeeBumpTransactionDecodeRequest
            if (!model.IsDefined(typeof(Stellar.FeeBumpTransactionDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.FeeBumpTransactionDecodeRequest), false);
