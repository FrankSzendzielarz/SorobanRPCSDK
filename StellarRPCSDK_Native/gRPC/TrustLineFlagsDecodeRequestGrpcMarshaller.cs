...
{
    /// <summary>Custom marshaller for Stellar.TrustLineFlagsDecodeRequest</summary>
    public static class TrustLineFlagsDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static TrustLineFlagsDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TrustLineFlagsDecodeRequest
            if (!model.IsDefined(typeof(Stellar.TrustLineFlagsDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.TrustLineFlagsDecodeRequest), false);
