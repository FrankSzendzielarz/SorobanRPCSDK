...
{
    /// <summary>Custom marshaller for Stellar.PriceEncodeRequest</summary>
    public static class PriceEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static PriceEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.PriceEncodeRequest
            if (!model.IsDefined(typeof(Stellar.PriceEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.PriceEncodeRequest), false);
