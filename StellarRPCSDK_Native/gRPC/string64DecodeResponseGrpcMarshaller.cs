...
{
    /// <summary>Custom marshaller for Stellar.string64DecodeResponse</summary>
    public static class string64DecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static string64DecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.string64DecodeResponse
            if (!model.IsDefined(typeof(Stellar.string64DecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.string64DecodeResponse), false);
