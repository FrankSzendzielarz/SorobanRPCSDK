...
{
    /// <summary>Custom marshaller for Stellar.SCPStatementDecodeResponse</summary>
    public static class SCPStatementDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SCPStatementDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCPStatementDecodeResponse
            if (!model.IsDefined(typeof(Stellar.SCPStatementDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SCPStatementDecodeResponse), false);
