...
{
    /// <summary>Custom marshaller for Stellar.HmacSha256MacDecodeRequest</summary>
    public static class HmacSha256MacDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static HmacSha256MacDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.HmacSha256MacDecodeRequest
            if (!model.IsDefined(typeof(Stellar.HmacSha256MacDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.HmacSha256MacDecodeRequest), false);
