...
{
    /// <summary>Custom marshaller for Stellar.AccountEntryExtensionV3EncodeRequest</summary>
    public static class AccountEntryExtensionV3EncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static AccountEntryExtensionV3EncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.AccountEntryExtensionV3EncodeRequest
            if (!model.IsDefined(typeof(Stellar.AccountEntryExtensionV3EncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.AccountEntryExtensionV3EncodeRequest), false);
