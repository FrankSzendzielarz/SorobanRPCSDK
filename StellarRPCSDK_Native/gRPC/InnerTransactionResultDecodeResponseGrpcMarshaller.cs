...
{
    /// <summary>Custom marshaller for Stellar.InnerTransactionResultDecodeResponse</summary>
    public static class InnerTransactionResultDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static InnerTransactionResultDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.InnerTransactionResultDecodeResponse
            if (!model.IsDefined(typeof(Stellar.InnerTransactionResultDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.InnerTransactionResultDecodeResponse), false);
