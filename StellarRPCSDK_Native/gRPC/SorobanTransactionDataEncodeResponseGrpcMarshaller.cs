...
{
    /// <summary>Custom marshaller for Stellar.SorobanTransactionDataEncodeResponse</summary>
    public static class SorobanTransactionDataEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SorobanTransactionDataEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SorobanTransactionDataEncodeResponse
            if (!model.IsDefined(typeof(Stellar.SorobanTransactionDataEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SorobanTransactionDataEncodeResponse), false);
