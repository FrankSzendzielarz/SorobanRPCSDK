...
{
    /// <summary>Custom marshaller for Stellar.SignatureDecodeRequest</summary>
    public static class SignatureDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SignatureDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SignatureDecodeRequest
            if (!model.IsDefined(typeof(Stellar.SignatureDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SignatureDecodeRequest), false);
