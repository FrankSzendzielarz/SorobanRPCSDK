...
{
    /// <summary>Custom marshaller for Stellar.SorobanAuthorizedFunctionTypeDecodeRequest</summary>
    public static class SorobanAuthorizedFunctionTypeDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SorobanAuthorizedFunctionTypeDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SorobanAuthorizedFunctionTypeDecodeRequest
            if (!model.IsDefined(typeof(Stellar.SorobanAuthorizedFunctionTypeDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SorobanAuthorizedFunctionTypeDecodeRequest), false);
