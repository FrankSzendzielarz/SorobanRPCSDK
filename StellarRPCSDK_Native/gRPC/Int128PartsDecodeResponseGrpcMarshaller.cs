...
{
    /// <summary>Custom marshaller for Stellar.Int128PartsDecodeResponse</summary>
    public static class Int128PartsDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static Int128PartsDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.Int128PartsDecodeResponse
            if (!model.IsDefined(typeof(Stellar.Int128PartsDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.Int128PartsDecodeResponse), false);
