...
{
    /// <summary>Custom marshaller for Stellar.ContractDataEntryDecodeResponse</summary>
    public static class ContractDataEntryDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ContractDataEntryDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ContractDataEntryDecodeResponse
            if (!model.IsDefined(typeof(Stellar.ContractDataEntryDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ContractDataEntryDecodeResponse), false);
