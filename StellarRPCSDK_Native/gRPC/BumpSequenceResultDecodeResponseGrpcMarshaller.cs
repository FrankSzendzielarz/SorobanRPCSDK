...
{
    /// <summary>Custom marshaller for Stellar.BumpSequenceResultDecodeResponse</summary>
    public static class BumpSequenceResultDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static BumpSequenceResultDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.BumpSequenceResultDecodeResponse
            if (!model.IsDefined(typeof(Stellar.BumpSequenceResultDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.BumpSequenceResultDecodeResponse), false);
