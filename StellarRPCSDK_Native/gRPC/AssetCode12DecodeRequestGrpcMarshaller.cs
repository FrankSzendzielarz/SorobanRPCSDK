...
{
    /// <summary>Custom marshaller for Stellar.AssetCode12DecodeRequest</summary>
    public static class AssetCode12DecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static AssetCode12DecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.AssetCode12DecodeRequest
            if (!model.IsDefined(typeof(Stellar.AssetCode12DecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.AssetCode12DecodeRequest), false);
