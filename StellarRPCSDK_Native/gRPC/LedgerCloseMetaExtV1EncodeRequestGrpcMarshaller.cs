...
{
    /// <summary>Custom marshaller for Stellar.LedgerCloseMetaExtV1EncodeRequest</summary>
    public static class LedgerCloseMetaExtV1EncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static LedgerCloseMetaExtV1EncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.LedgerCloseMetaExtV1EncodeRequest
            if (!model.IsDefined(typeof(Stellar.LedgerCloseMetaExtV1EncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.LedgerCloseMetaExtV1EncodeRequest), false);
