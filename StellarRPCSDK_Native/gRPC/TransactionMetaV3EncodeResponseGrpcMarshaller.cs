...
{
    /// <summary>Custom marshaller for Stellar.TransactionMetaV3EncodeResponse</summary>
    public static class TransactionMetaV3EncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static TransactionMetaV3EncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TransactionMetaV3EncodeResponse
            if (!model.IsDefined(typeof(Stellar.TransactionMetaV3EncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.TransactionMetaV3EncodeResponse), false);
