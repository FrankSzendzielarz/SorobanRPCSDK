...
{
    /// <summary>Custom marshaller for Stellar.ClaimableBalanceEntryEncodeResponse</summary>
    public static class ClaimableBalanceEntryEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ClaimableBalanceEntryEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ClaimableBalanceEntryEncodeResponse
            if (!model.IsDefined(typeof(Stellar.ClaimableBalanceEntryEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ClaimableBalanceEntryEncodeResponse), false);
