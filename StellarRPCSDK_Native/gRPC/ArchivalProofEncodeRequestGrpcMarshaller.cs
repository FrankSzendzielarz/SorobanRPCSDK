...
{
    /// <summary>Custom marshaller for Stellar.ArchivalProofEncodeRequest</summary>
    public static class ArchivalProofEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ArchivalProofEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ArchivalProofEncodeRequest
            if (!model.IsDefined(typeof(Stellar.ArchivalProofEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ArchivalProofEncodeRequest), false);
