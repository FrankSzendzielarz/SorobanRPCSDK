...
{
    /// <summary>Custom marshaller for Stellar.PeerStatListEncodeRequest</summary>
    public static class PeerStatListEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static PeerStatListEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.PeerStatListEncodeRequest
            if (!model.IsDefined(typeof(Stellar.PeerStatListEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.PeerStatListEncodeRequest), false);
