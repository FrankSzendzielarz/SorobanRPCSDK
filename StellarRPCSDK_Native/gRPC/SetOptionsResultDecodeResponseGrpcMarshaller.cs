...
{
    /// <summary>Custom marshaller for Stellar.SetOptionsResultDecodeResponse</summary>
    public static class SetOptionsResultDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SetOptionsResultDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SetOptionsResultDecodeResponse
            if (!model.IsDefined(typeof(Stellar.SetOptionsResultDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SetOptionsResultDecodeResponse), false);
