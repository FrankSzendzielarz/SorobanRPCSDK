...
{
    /// <summary>Custom marshaller for Stellar.SCAddressEncodeRequest</summary>
    public static class SCAddressEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SCAddressEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCAddressEncodeRequest
            if (!model.IsDefined(typeof(Stellar.SCAddressEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SCAddressEncodeRequest), false);
