...
{
    /// <summary>Custom marshaller for Stellar.string64EncodeRequest</summary>
    public static class string64EncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static string64EncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.string64EncodeRequest
            if (!model.IsDefined(typeof(Stellar.string64EncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.string64EncodeRequest), false);
