...
{
    /// <summary>Custom marshaller for Stellar.TransactionResultPairEncodeResponse</summary>
    public static class TransactionResultPairEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static TransactionResultPairEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TransactionResultPairEncodeResponse
            if (!model.IsDefined(typeof(Stellar.TransactionResultPairEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.TransactionResultPairEncodeResponse), false);
