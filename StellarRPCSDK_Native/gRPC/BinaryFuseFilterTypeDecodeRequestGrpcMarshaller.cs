...
{
    /// <summary>Custom marshaller for Stellar.BinaryFuseFilterTypeDecodeRequest</summary>
    public static class BinaryFuseFilterTypeDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static BinaryFuseFilterTypeDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.BinaryFuseFilterTypeDecodeRequest
            if (!model.IsDefined(typeof(Stellar.BinaryFuseFilterTypeDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.BinaryFuseFilterTypeDecodeRequest), false);
