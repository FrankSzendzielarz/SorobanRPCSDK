...
{
    /// <summary>Custom marshaller for Stellar.BumpSequenceOpEncodeRequest</summary>
    public static class BumpSequenceOpEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static BumpSequenceOpEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.BumpSequenceOpEncodeRequest
            if (!model.IsDefined(typeof(Stellar.BumpSequenceOpEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.BumpSequenceOpEncodeRequest), false);
