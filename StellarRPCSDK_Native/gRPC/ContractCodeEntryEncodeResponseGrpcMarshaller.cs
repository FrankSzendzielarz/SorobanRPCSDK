...
{
    /// <summary>Custom marshaller for Stellar.ContractCodeEntryEncodeResponse</summary>
    public static class ContractCodeEntryEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ContractCodeEntryEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ContractCodeEntryEncodeResponse
            if (!model.IsDefined(typeof(Stellar.ContractCodeEntryEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ContractCodeEntryEncodeResponse), false);
