...
{
    /// <summary>Custom marshaller for Stellar.SendMoreDecodeResponse</summary>
    public static class SendMoreDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SendMoreDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SendMoreDecodeResponse
            if (!model.IsDefined(typeof(Stellar.SendMoreDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SendMoreDecodeResponse), false);
