...
{
    /// <summary>Custom marshaller for Stellar.ClaimClaimableBalanceOpDecodeRequest</summary>
    public static class ClaimClaimableBalanceOpDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ClaimClaimableBalanceOpDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ClaimClaimableBalanceOpDecodeRequest
            if (!model.IsDefined(typeof(Stellar.ClaimClaimableBalanceOpDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ClaimClaimableBalanceOpDecodeRequest), false);
