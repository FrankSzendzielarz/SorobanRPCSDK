...
{
    /// <summary>Custom marshaller for Stellar.ChangeTrustResultCodeEncodeResponse</summary>
    public static class ChangeTrustResultCodeEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ChangeTrustResultCodeEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ChangeTrustResultCodeEncodeResponse
            if (!model.IsDefined(typeof(Stellar.ChangeTrustResultCodeEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ChangeTrustResultCodeEncodeResponse), false);
