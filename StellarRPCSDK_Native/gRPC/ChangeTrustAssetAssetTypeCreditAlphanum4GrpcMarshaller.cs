...
namespace Stellar.RPC.AOT
{
    ...
    public static class ChangeTrustAssetAssetTypeCreditAlphanum4GrpcMarshaller
    {
        ...
        public static readonly Marshaller<Stellar.ChangeTrustAsset.AssetTypeCreditAlphanum4> AssetTypeCreditAlphanum4Marshaller = Marshallers.Create<Stellar.ChangeTrustAsset.AssetTypeCreditAlphanum4>(
