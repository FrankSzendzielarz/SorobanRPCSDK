...
{
    /// <summary>Custom marshaller for Stellar.ValueDecodeResponse</summary>
    public static class ValueDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ValueDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ValueDecodeResponse
            if (!model.IsDefined(typeof(Stellar.ValueDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ValueDecodeResponse), false);
