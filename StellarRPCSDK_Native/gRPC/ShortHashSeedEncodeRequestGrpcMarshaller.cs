...
{
    /// <summary>Custom marshaller for Stellar.ShortHashSeedEncodeRequest</summary>
    public static class ShortHashSeedEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ShortHashSeedEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ShortHashSeedEncodeRequest
            if (!model.IsDefined(typeof(Stellar.ShortHashSeedEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ShortHashSeedEncodeRequest), false);
