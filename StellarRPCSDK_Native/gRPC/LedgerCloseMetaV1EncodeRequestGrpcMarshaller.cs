...
{
    /// <summary>Custom marshaller for Stellar.LedgerCloseMetaV1EncodeRequest</summary>
    public static class LedgerCloseMetaV1EncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static LedgerCloseMetaV1EncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.LedgerCloseMetaV1EncodeRequest
            if (!model.IsDefined(typeof(Stellar.LedgerCloseMetaV1EncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.LedgerCloseMetaV1EncodeRequest), false);
