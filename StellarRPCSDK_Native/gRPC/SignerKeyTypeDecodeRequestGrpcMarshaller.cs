...
{
    /// <summary>Custom marshaller for Stellar.SignerKeyTypeDecodeRequest</summary>
    public static class SignerKeyTypeDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SignerKeyTypeDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SignerKeyTypeDecodeRequest
            if (!model.IsDefined(typeof(Stellar.SignerKeyTypeDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SignerKeyTypeDecodeRequest), false);
