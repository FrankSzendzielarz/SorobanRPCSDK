...
{
    /// <summary>Custom marshaller for Stellar.ManageBuyOfferOpDecodeResponse</summary>
    public static class ManageBuyOfferOpDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ManageBuyOfferOpDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ManageBuyOfferOpDecodeResponse
            if (!model.IsDefined(typeof(Stellar.ManageBuyOfferOpDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ManageBuyOfferOpDecodeResponse), false);
