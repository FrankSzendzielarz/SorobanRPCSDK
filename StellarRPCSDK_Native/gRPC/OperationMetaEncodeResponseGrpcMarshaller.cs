...
{
    /// <summary>Custom marshaller for Stellar.OperationMetaEncodeResponse</summary>
    public static class OperationMetaEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static OperationMetaEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.OperationMetaEncodeResponse
            if (!model.IsDefined(typeof(Stellar.OperationMetaEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.OperationMetaEncodeResponse), false);
