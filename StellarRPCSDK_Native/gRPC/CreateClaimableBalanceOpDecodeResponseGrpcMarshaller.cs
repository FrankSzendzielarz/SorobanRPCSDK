...
{
    /// <summary>Custom marshaller for Stellar.CreateClaimableBalanceOpDecodeResponse</summary>
    public static class CreateClaimableBalanceOpDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static CreateClaimableBalanceOpDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.CreateClaimableBalanceOpDecodeResponse
            if (!model.IsDefined(typeof(Stellar.CreateClaimableBalanceOpDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.CreateClaimableBalanceOpDecodeResponse), false);
