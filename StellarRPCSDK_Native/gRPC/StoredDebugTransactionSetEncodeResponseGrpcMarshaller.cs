...
{
    /// <summary>Custom marshaller for Stellar.StoredDebugTransactionSetEncodeResponse</summary>
    public static class StoredDebugTransactionSetEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static StoredDebugTransactionSetEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.StoredDebugTransactionSetEncodeResponse
            if (!model.IsDefined(typeof(Stellar.StoredDebugTransactionSetEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.StoredDebugTransactionSetEncodeResponse), false);
