...
{
    /// <summary>Custom marshaller for Stellar.CreateAccountResultCodeEncodeRequest</summary>
    public static class CreateAccountResultCodeEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static CreateAccountResultCodeEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.CreateAccountResultCodeEncodeRequest
            if (!model.IsDefined(typeof(Stellar.CreateAccountResultCodeEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.CreateAccountResultCodeEncodeRequest), false);
