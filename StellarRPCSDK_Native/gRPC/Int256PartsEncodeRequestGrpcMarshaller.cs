...
{
    /// <summary>Custom marshaller for Stellar.Int256PartsEncodeRequest</summary>
    public static class Int256PartsEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static Int256PartsEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.Int256PartsEncodeRequest
            if (!model.IsDefined(typeof(Stellar.Int256PartsEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.Int256PartsEncodeRequest), false);
