...
{
    /// <summary>Custom marshaller for Stellar.PaymentResultDecodeRequest</summary>
    public static class PaymentResultDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static PaymentResultDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.PaymentResultDecodeRequest
            if (!model.IsDefined(typeof(Stellar.PaymentResultDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.PaymentResultDecodeRequest), false);
