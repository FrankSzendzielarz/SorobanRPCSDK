...
{
    /// <summary>Custom marshaller for Stellar.PeerAddressDecodeRequest</summary>
    public static class PeerAddressDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static PeerAddressDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.PeerAddressDecodeRequest
            if (!model.IsDefined(typeof(Stellar.PeerAddressDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.PeerAddressDecodeRequest), false);
