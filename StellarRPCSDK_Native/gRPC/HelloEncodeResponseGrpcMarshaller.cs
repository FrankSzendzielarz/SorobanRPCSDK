...
{
    /// <summary>Custom marshaller for Stellar.HelloEncodeResponse</summary>
    public static class HelloEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static HelloEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.HelloEncodeResponse
            if (!model.IsDefined(typeof(Stellar.HelloEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.HelloEncodeResponse), false);
