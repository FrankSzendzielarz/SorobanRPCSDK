...
{
    /// <summary>Custom marshaller for Stellar.AccountFlagsEncodeRequest</summary>
    public static class AccountFlagsEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static AccountFlagsEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.AccountFlagsEncodeRequest
            if (!model.IsDefined(typeof(Stellar.AccountFlagsEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.AccountFlagsEncodeRequest), false);
