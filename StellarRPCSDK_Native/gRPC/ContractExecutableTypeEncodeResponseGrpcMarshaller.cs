...
{
    /// <summary>Custom marshaller for Stellar.ContractExecutableTypeEncodeResponse</summary>
    public static class ContractExecutableTypeEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ContractExecutableTypeEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ContractExecutableTypeEncodeResponse
            if (!model.IsDefined(typeof(Stellar.ContractExecutableTypeEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ContractExecutableTypeEncodeResponse), false);
