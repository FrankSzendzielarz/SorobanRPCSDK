...
{
    /// <summary>Custom marshaller for Stellar.SCNonceKeyEncodeRequest</summary>
    public static class SCNonceKeyEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SCNonceKeyEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCNonceKeyEncodeRequest
            if (!model.IsDefined(typeof(Stellar.SCNonceKeyEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SCNonceKeyEncodeRequest), false);
