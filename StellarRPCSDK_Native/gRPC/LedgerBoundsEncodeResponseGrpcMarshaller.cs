...
{
    /// <summary>Custom marshaller for Stellar.LedgerBoundsEncodeResponse</summary>
    public static class LedgerBoundsEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static LedgerBoundsEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.LedgerBoundsEncodeResponse
            if (!model.IsDefined(typeof(Stellar.LedgerBoundsEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.LedgerBoundsEncodeResponse), false);
