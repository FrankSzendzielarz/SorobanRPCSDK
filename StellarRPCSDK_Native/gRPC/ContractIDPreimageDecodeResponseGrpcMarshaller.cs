...
{
    /// <summary>Custom marshaller for Stellar.ContractIDPreimageDecodeResponse</summary>
    public static class ContractIDPreimageDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ContractIDPreimageDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ContractIDPreimageDecodeResponse
            if (!model.IsDefined(typeof(Stellar.ContractIDPreimageDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ContractIDPreimageDecodeResponse), false);
