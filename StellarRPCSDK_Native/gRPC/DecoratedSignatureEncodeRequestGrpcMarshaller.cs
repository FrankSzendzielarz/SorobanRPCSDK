...
{
    /// <summary>Custom marshaller for Stellar.DecoratedSignatureEncodeRequest</summary>
    public static class DecoratedSignatureEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static DecoratedSignatureEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.DecoratedSignatureEncodeRequest
            if (!model.IsDefined(typeof(Stellar.DecoratedSignatureEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.DecoratedSignatureEncodeRequest), false);
