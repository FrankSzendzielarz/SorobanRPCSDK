...
{
    /// <summary>Custom marshaller for Stellar.SCPNominationDecodeResponse</summary>
    public static class SCPNominationDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SCPNominationDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCPNominationDecodeResponse
            if (!model.IsDefined(typeof(Stellar.SCPNominationDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SCPNominationDecodeResponse), false);
