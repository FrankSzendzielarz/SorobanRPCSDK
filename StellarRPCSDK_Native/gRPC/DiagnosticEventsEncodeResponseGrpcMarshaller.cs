...
{
    /// <summary>Custom marshaller for Stellar.DiagnosticEventsEncodeResponse</summary>
    public static class DiagnosticEventsEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static DiagnosticEventsEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.DiagnosticEventsEncodeResponse
            if (!model.IsDefined(typeof(Stellar.DiagnosticEventsEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.DiagnosticEventsEncodeResponse), false);
