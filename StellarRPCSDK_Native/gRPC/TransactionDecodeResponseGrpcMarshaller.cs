...
{
    /// <summary>Custom marshaller for Stellar.TransactionDecodeResponse</summary>
    public static class TransactionDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static TransactionDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TransactionDecodeResponse
            if (!model.IsDefined(typeof(Stellar.TransactionDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.TransactionDecodeResponse), false);
