...
{
    /// <summary>Custom marshaller for Stellar.TimeSlicedNodeDataDecodeResponse</summary>
    public static class TimeSlicedNodeDataDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static TimeSlicedNodeDataDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TimeSlicedNodeDataDecodeResponse
            if (!model.IsDefined(typeof(Stellar.TimeSlicedNodeDataDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.TimeSlicedNodeDataDecodeResponse), false);
