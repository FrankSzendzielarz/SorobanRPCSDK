...
{
    /// <summary>Custom marshaller for Stellar.SurveyMessageCommandTypeDecodeRequest</summary>
    public static class SurveyMessageCommandTypeDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SurveyMessageCommandTypeDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SurveyMessageCommandTypeDecodeRequest
            if (!model.IsDefined(typeof(Stellar.SurveyMessageCommandTypeDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SurveyMessageCommandTypeDecodeRequest), false);
