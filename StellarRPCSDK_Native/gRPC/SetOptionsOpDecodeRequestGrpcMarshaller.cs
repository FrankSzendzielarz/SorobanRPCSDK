...
{
    /// <summary>Custom marshaller for Stellar.SetOptionsOpDecodeRequest</summary>
    public static class SetOptionsOpDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SetOptionsOpDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SetOptionsOpDecodeRequest
            if (!model.IsDefined(typeof(Stellar.SetOptionsOpDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SetOptionsOpDecodeRequest), false);
