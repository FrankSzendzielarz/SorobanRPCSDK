...
{
    /// <summary>Custom marshaller for Stellar.SCSpecFunctionV0DecodeRequest</summary>
    public static class SCSpecFunctionV0DecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SCSpecFunctionV0DecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCSpecFunctionV0DecodeRequest
            if (!model.IsDefined(typeof(Stellar.SCSpecFunctionV0DecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SCSpecFunctionV0DecodeRequest), false);
