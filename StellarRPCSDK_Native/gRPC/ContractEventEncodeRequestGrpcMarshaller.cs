...
{
    /// <summary>Custom marshaller for Stellar.ContractEventEncodeRequest</summary>
    public static class ContractEventEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ContractEventEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ContractEventEncodeRequest
            if (!model.IsDefined(typeof(Stellar.ContractEventEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ContractEventEncodeRequest), false);
