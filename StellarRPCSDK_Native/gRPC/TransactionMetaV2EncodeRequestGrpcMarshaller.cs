...
{
    /// <summary>Custom marshaller for Stellar.TransactionMetaV2EncodeRequest</summary>
    public static class TransactionMetaV2EncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static TransactionMetaV2EncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TransactionMetaV2EncodeRequest
            if (!model.IsDefined(typeof(Stellar.TransactionMetaV2EncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.TransactionMetaV2EncodeRequest), false);
