...
{
    /// <summary>Custom marshaller for Stellar.InvokeHostFunctionResultDecodeResponse</summary>
    public static class InvokeHostFunctionResultDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static InvokeHostFunctionResultDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.InvokeHostFunctionResultDecodeResponse
            if (!model.IsDefined(typeof(Stellar.InvokeHostFunctionResultDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.InvokeHostFunctionResultDecodeResponse), false);
