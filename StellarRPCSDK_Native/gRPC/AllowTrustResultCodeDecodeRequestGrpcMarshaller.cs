...
{
    /// <summary>Custom marshaller for Stellar.AllowTrustResultCodeDecodeRequest</summary>
    public static class AllowTrustResultCodeDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static AllowTrustResultCodeDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.AllowTrustResultCodeDecodeRequest
            if (!model.IsDefined(typeof(Stellar.AllowTrustResultCodeDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.AllowTrustResultCodeDecodeRequest), false);
