...
{
    /// <summary>Custom marshaller for Stellar.LedgerBoundsDecodeResponse</summary>
    public static class LedgerBoundsDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static LedgerBoundsDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.LedgerBoundsDecodeResponse
            if (!model.IsDefined(typeof(Stellar.LedgerBoundsDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.LedgerBoundsDecodeResponse), false);
