...
{
    /// <summary>Custom marshaller for Stellar.ClaimableBalanceIDTypeEncodeRequest</summary>
    public static class ClaimableBalanceIDTypeEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ClaimableBalanceIDTypeEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ClaimableBalanceIDTypeEncodeRequest
            if (!model.IsDefined(typeof(Stellar.ClaimableBalanceIDTypeEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ClaimableBalanceIDTypeEncodeRequest), false);
