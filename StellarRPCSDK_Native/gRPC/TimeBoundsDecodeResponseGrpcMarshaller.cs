...
{
    /// <summary>Custom marshaller for Stellar.TimeBoundsDecodeResponse</summary>
    public static class TimeBoundsDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static TimeBoundsDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TimeBoundsDecodeResponse
            if (!model.IsDefined(typeof(Stellar.TimeBoundsDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.TimeBoundsDecodeResponse), false);
