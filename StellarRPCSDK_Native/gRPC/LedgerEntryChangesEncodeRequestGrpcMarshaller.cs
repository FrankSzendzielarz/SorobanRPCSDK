...
{
    /// <summary>Custom marshaller for Stellar.LedgerEntryChangesEncodeRequest</summary>
    public static class LedgerEntryChangesEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static LedgerEntryChangesEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.LedgerEntryChangesEncodeRequest
            if (!model.IsDefined(typeof(Stellar.LedgerEntryChangesEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.LedgerEntryChangesEncodeRequest), false);
