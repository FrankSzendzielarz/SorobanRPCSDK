...
{
    /// <summary>Custom marshaller for Stellar.CreateClaimableBalanceResultCodeEncodeRequest</summary>
    public static class CreateClaimableBalanceResultCodeEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static CreateClaimableBalanceResultCodeEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.CreateClaimableBalanceResultCodeEncodeRequest
            if (!model.IsDefined(typeof(Stellar.CreateClaimableBalanceResultCodeEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.CreateClaimableBalanceResultCodeEncodeRequest), false);
