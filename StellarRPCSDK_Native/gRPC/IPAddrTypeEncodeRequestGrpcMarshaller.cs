...
{
    /// <summary>Custom marshaller for Stellar.IPAddrTypeEncodeRequest</summary>
    public static class IPAddrTypeEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static IPAddrTypeEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.IPAddrTypeEncodeRequest
            if (!model.IsDefined(typeof(Stellar.IPAddrTypeEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.IPAddrTypeEncodeRequest), false);
