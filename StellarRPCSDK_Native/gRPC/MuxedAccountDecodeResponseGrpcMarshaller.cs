...
{
    /// <summary>Custom marshaller for Stellar.MuxedAccountDecodeResponse</summary>
    public static class MuxedAccountDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static MuxedAccountDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.MuxedAccountDecodeResponse
            if (!model.IsDefined(typeof(Stellar.MuxedAccountDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.MuxedAccountDecodeResponse), false);
