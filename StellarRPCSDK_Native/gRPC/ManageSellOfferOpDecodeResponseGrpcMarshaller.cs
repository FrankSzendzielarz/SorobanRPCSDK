...
{
    /// <summary>Custom marshaller for Stellar.ManageSellOfferOpDecodeResponse</summary>
    public static class ManageSellOfferOpDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ManageSellOfferOpDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ManageSellOfferOpDecodeResponse
            if (!model.IsDefined(typeof(Stellar.ManageSellOfferOpDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ManageSellOfferOpDecodeResponse), false);
