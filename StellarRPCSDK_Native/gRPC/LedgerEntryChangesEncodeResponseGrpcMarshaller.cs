...
{
    /// <summary>Custom marshaller for Stellar.LedgerEntryChangesEncodeResponse</summary>
    public static class LedgerEntryChangesEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static LedgerEntryChangesEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.LedgerEntryChangesEncodeResponse
            if (!model.IsDefined(typeof(Stellar.LedgerEntryChangesEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.LedgerEntryChangesEncodeResponse), false);
