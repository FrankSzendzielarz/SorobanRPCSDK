...
{
    /// <summary>Custom marshaller for Stellar.RevokeSponsorshipResultDecodeRequest</summary>
    public static class RevokeSponsorshipResultDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static RevokeSponsorshipResultDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.RevokeSponsorshipResultDecodeRequest
            if (!model.IsDefined(typeof(Stellar.RevokeSponsorshipResultDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.RevokeSponsorshipResultDecodeRequest), false);
