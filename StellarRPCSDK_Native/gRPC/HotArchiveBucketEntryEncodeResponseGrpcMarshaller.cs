...
{
    /// <summary>Custom marshaller for Stellar.HotArchiveBucketEntryEncodeResponse</summary>
    public static class HotArchiveBucketEntryEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static HotArchiveBucketEntryEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.HotArchiveBucketEntryEncodeResponse
            if (!model.IsDefined(typeof(Stellar.HotArchiveBucketEntryEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.HotArchiveBucketEntryEncodeResponse), false);
