...
{
    /// <summary>Custom marshaller for Stellar.SCPStatementEncodeRequest</summary>
    public static class SCPStatementEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SCPStatementEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCPStatementEncodeRequest
            if (!model.IsDefined(typeof(Stellar.SCPStatementEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SCPStatementEncodeRequest), false);
