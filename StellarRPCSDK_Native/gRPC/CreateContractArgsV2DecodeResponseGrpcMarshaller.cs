...
{
    /// <summary>Custom marshaller for Stellar.CreateContractArgsV2DecodeResponse</summary>
    public static class CreateContractArgsV2DecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static CreateContractArgsV2DecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.CreateContractArgsV2DecodeResponse
            if (!model.IsDefined(typeof(Stellar.CreateContractArgsV2DecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.CreateContractArgsV2DecodeResponse), false);
