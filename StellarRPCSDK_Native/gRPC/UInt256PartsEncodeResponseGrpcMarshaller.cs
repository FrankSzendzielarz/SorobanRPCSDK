...
{
    /// <summary>Custom marshaller for Stellar.UInt256PartsEncodeResponse</summary>
    public static class UInt256PartsEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static UInt256PartsEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.UInt256PartsEncodeResponse
            if (!model.IsDefined(typeof(Stellar.UInt256PartsEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.UInt256PartsEncodeResponse), false);
