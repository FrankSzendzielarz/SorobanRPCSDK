...
{
    /// <summary>Custom marshaller for Stellar.Int128PartsEncodeRequest</summary>
    public static class Int128PartsEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static Int128PartsEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.Int128PartsEncodeRequest
            if (!model.IsDefined(typeof(Stellar.Int128PartsEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.Int128PartsEncodeRequest), false);
