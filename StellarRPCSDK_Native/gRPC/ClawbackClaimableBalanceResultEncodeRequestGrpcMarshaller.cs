...
{
    /// <summary>Custom marshaller for Stellar.ClawbackClaimableBalanceResultEncodeRequest</summary>
    public static class ClawbackClaimableBalanceResultEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ClawbackClaimableBalanceResultEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ClawbackClaimableBalanceResultEncodeRequest
            if (!model.IsDefined(typeof(Stellar.ClawbackClaimableBalanceResultEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ClawbackClaimableBalanceResultEncodeRequest), false);
