...
{
    /// <summary>Custom marshaller for Stellar.SCSpecUDTStructFieldV0EncodeResponse</summary>
    public static class SCSpecUDTStructFieldV0EncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SCSpecUDTStructFieldV0EncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCSpecUDTStructFieldV0EncodeResponse
            if (!model.IsDefined(typeof(Stellar.SCSpecUDTStructFieldV0EncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SCSpecUDTStructFieldV0EncodeResponse), false);
