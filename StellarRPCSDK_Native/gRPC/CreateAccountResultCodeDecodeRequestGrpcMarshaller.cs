...
{
    /// <summary>Custom marshaller for Stellar.CreateAccountResultCodeDecodeRequest</summary>
    public static class CreateAccountResultCodeDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static CreateAccountResultCodeDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.CreateAccountResultCodeDecodeRequest
            if (!model.IsDefined(typeof(Stellar.CreateAccountResultCodeDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.CreateAccountResultCodeDecodeRequest), false);
