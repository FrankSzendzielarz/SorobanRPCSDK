...
{
    /// <summary>Custom marshaller for Stellar.ConfigUpgradeSetEncodeRequest</summary>
    public static class ConfigUpgradeSetEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ConfigUpgradeSetEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ConfigUpgradeSetEncodeRequest
            if (!model.IsDefined(typeof(Stellar.ConfigUpgradeSetEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ConfigUpgradeSetEncodeRequest), false);
