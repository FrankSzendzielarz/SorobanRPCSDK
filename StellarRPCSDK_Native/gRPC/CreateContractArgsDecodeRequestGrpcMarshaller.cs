...
{
    /// <summary>Custom marshaller for Stellar.CreateContractArgsDecodeRequest</summary>
    public static class CreateContractArgsDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static CreateContractArgsDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.CreateContractArgsDecodeRequest
            if (!model.IsDefined(typeof(Stellar.CreateContractArgsDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.CreateContractArgsDecodeRequest), false);
