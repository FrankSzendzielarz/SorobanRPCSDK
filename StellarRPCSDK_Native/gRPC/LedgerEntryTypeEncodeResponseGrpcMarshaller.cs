...
{
    /// <summary>Custom marshaller for Stellar.LedgerEntryTypeEncodeResponse</summary>
    public static class LedgerEntryTypeEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static LedgerEntryTypeEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.LedgerEntryTypeEncodeResponse
            if (!model.IsDefined(typeof(Stellar.LedgerEntryTypeEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.LedgerEntryTypeEncodeResponse), false);
