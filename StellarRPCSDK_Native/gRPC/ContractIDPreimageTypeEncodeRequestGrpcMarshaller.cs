...
{
    /// <summary>Custom marshaller for Stellar.ContractIDPreimageTypeEncodeRequest</summary>
    public static class ContractIDPreimageTypeEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ContractIDPreimageTypeEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ContractIDPreimageTypeEncodeRequest
            if (!model.IsDefined(typeof(Stellar.ContractIDPreimageTypeEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ContractIDPreimageTypeEncodeRequest), false);
