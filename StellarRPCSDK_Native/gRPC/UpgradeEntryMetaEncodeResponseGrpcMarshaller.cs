...
{
    /// <summary>Custom marshaller for Stellar.UpgradeEntryMetaEncodeResponse</summary>
    public static class UpgradeEntryMetaEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static UpgradeEntryMetaEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.UpgradeEntryMetaEncodeResponse
            if (!model.IsDefined(typeof(Stellar.UpgradeEntryMetaEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.UpgradeEntryMetaEncodeResponse), false);
