...
{
    /// <summary>Custom marshaller for Stellar.ClaimableBalanceFlagsEncodeRequest</summary>
    public static class ClaimableBalanceFlagsEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ClaimableBalanceFlagsEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ClaimableBalanceFlagsEncodeRequest
            if (!model.IsDefined(typeof(Stellar.ClaimableBalanceFlagsEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ClaimableBalanceFlagsEncodeRequest), false);
