...
{
    /// <summary>Custom marshaller for Stellar.SCSpecTypeTupleDecodeRequest</summary>
    public static class SCSpecTypeTupleDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SCSpecTypeTupleDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCSpecTypeTupleDecodeRequest
            if (!model.IsDefined(typeof(Stellar.SCSpecTypeTupleDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SCSpecTypeTupleDecodeRequest), false);
