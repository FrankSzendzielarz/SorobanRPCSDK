...
{
    /// <summary>Custom marshaller for Stellar.PeerStatListEncodeResponse</summary>
    public static class PeerStatListEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static PeerStatListEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.PeerStatListEncodeResponse
            if (!model.IsDefined(typeof(Stellar.PeerStatListEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.PeerStatListEncodeResponse), false);
