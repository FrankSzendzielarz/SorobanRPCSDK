...
{
    /// <summary>Custom marshaller for Stellar.TxDemandVectorEncodeRequest</summary>
    public static class TxDemandVectorEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static TxDemandVectorEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TxDemandVectorEncodeRequest
            if (!model.IsDefined(typeof(Stellar.TxDemandVectorEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.TxDemandVectorEncodeRequest), false);
