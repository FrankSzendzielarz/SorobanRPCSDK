...
{
    /// <summary>Custom marshaller for Stellar.SCPHistoryEntryEncodeResponse</summary>
    public static class SCPHistoryEntryEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SCPHistoryEntryEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCPHistoryEntryEncodeResponse
            if (!model.IsDefined(typeof(Stellar.SCPHistoryEntryEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SCPHistoryEntryEncodeResponse), false);
