...
{
    /// <summary>Custom marshaller for Stellar.SignerEncodeResponse</summary>
    public static class SignerEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SignerEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SignerEncodeResponse
            if (!model.IsDefined(typeof(Stellar.SignerEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SignerEncodeResponse), false);
