...
{
    /// <summary>Custom marshaller for Stellar.RevokeSponsorshipTypeDecodeResponse</summary>
    public static class RevokeSponsorshipTypeDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static RevokeSponsorshipTypeDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.RevokeSponsorshipTypeDecodeResponse
            if (!model.IsDefined(typeof(Stellar.RevokeSponsorshipTypeDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.RevokeSponsorshipTypeDecodeResponse), false);
