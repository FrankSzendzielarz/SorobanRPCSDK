...
{
    /// <summary>Custom marshaller for Stellar.AllowTrustResultDecodeRequest</summary>
    public static class AllowTrustResultDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static AllowTrustResultDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.AllowTrustResultDecodeRequest
            if (!model.IsDefined(typeof(Stellar.AllowTrustResultDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.AllowTrustResultDecodeRequest), false);
