...
{
    /// <summary>Custom marshaller for Stellar.SCPNominationDecodeRequest</summary>
    public static class SCPNominationDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SCPNominationDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCPNominationDecodeRequest
            if (!model.IsDefined(typeof(Stellar.SCPNominationDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SCPNominationDecodeRequest), false);
