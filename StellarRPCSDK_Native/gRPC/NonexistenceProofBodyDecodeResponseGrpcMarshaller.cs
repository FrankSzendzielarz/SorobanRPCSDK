...
{
    /// <summary>Custom marshaller for Stellar.NonexistenceProofBodyDecodeResponse</summary>
    public static class NonexistenceProofBodyDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static NonexistenceProofBodyDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.NonexistenceProofBodyDecodeResponse
            if (!model.IsDefined(typeof(Stellar.NonexistenceProofBodyDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.NonexistenceProofBodyDecodeResponse), false);
