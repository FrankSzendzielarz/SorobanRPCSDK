...
{
    /// <summary>Custom marshaller for Stellar.SCBytesDecodeResponse</summary>
    public static class SCBytesDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SCBytesDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCBytesDecodeResponse
            if (!model.IsDefined(typeof(Stellar.SCBytesDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SCBytesDecodeResponse), false);
