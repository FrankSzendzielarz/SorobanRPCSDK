...
{
    /// <summary>Custom marshaller for Stellar.HostFunctionTypeDecodeRequest</summary>
    public static class HostFunctionTypeDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static HostFunctionTypeDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.HostFunctionTypeDecodeRequest
            if (!model.IsDefined(typeof(Stellar.HostFunctionTypeDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.HostFunctionTypeDecodeRequest), false);
