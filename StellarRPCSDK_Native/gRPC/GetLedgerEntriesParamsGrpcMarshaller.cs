...
{
    /// <summary>Custom marshaller for Stellar.RPC.GetLedgerEntriesParams</summary>
    public static class GetLedgerEntriesParamsGrpcMarshaller
    {
        // Static constructor to configure type
        static GetLedgerEntriesParamsGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.RPC.GetLedgerEntriesParams
            if (!model.IsDefined(typeof(Stellar.RPC.GetLedgerEntriesParams)))
            {
                var metaType = model.Add(typeof(Stellar.RPC.GetLedgerEntriesParams), false);
