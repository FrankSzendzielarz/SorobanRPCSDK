...
{
    /// <summary>Custom marshaller for Stellar.MemoTypeEncodeResponse</summary>
    public static class MemoTypeEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static MemoTypeEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.MemoTypeEncodeResponse
            if (!model.IsDefined(typeof(Stellar.MemoTypeEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.MemoTypeEncodeResponse), false);
