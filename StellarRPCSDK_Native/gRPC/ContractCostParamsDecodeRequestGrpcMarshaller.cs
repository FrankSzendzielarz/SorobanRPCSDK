...
{
    /// <summary>Custom marshaller for Stellar.ContractCostParamsDecodeRequest</summary>
    public static class ContractCostParamsDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ContractCostParamsDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ContractCostParamsDecodeRequest
            if (!model.IsDefined(typeof(Stellar.ContractCostParamsDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ContractCostParamsDecodeRequest), false);
