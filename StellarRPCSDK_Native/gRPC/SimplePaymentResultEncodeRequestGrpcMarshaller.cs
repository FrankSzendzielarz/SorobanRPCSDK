...
{
    /// <summary>Custom marshaller for Stellar.SimplePaymentResultEncodeRequest</summary>
    public static class SimplePaymentResultEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SimplePaymentResultEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SimplePaymentResultEncodeRequest
            if (!model.IsDefined(typeof(Stellar.SimplePaymentResultEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SimplePaymentResultEncodeRequest), false);
