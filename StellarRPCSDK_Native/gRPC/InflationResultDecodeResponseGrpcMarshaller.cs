...
{
    /// <summary>Custom marshaller for Stellar.InflationResultDecodeResponse</summary>
    public static class InflationResultDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static InflationResultDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.InflationResultDecodeResponse
            if (!model.IsDefined(typeof(Stellar.InflationResultDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.InflationResultDecodeResponse), false);
