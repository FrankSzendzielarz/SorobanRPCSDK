...
{
    /// <summary>Custom marshaller for Stellar.AssetEncodeRequest</summary>
    public static class AssetEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static AssetEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.AssetEncodeRequest
            if (!model.IsDefined(typeof(Stellar.AssetEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.AssetEncodeRequest), false);
