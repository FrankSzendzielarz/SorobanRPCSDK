...
{
    /// <summary>Custom marshaller for Stellar.TransactionEncodeResponse</summary>
    public static class TransactionEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static TransactionEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TransactionEncodeResponse
            if (!model.IsDefined(typeof(Stellar.TransactionEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.TransactionEncodeResponse), false);
