...
{
    /// <summary>Custom marshaller for Stellar.string32DecodeRequest</summary>
    public static class string32DecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static string32DecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.string32DecodeRequest
            if (!model.IsDefined(typeof(Stellar.string32DecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.string32DecodeRequest), false);
