...
{
    /// <summary>Custom marshaller for Stellar.InvokeHostFunctionOpDecodeResponse</summary>
    public static class InvokeHostFunctionOpDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static InvokeHostFunctionOpDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.InvokeHostFunctionOpDecodeResponse
            if (!model.IsDefined(typeof(Stellar.InvokeHostFunctionOpDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.InvokeHostFunctionOpDecodeResponse), false);
