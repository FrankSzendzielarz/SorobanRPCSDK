...
{
    /// <summary>Custom marshaller for Stellar.ClaimOfferAtomV0EncodeResponse</summary>
    public static class ClaimOfferAtomV0EncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ClaimOfferAtomV0EncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ClaimOfferAtomV0EncodeResponse
            if (!model.IsDefined(typeof(Stellar.ClaimOfferAtomV0EncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ClaimOfferAtomV0EncodeResponse), false);
