...
{
    /// <summary>Custom marshaller for Stellar.SCPStatementTypeEncodeResponse</summary>
    public static class SCPStatementTypeEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SCPStatementTypeEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCPStatementTypeEncodeResponse
            if (!model.IsDefined(typeof(Stellar.SCPStatementTypeEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SCPStatementTypeEncodeResponse), false);
