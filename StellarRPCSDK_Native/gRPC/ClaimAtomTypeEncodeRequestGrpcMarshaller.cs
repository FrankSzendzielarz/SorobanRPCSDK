...
{
    /// <summary>Custom marshaller for Stellar.ClaimAtomTypeEncodeRequest</summary>
    public static class ClaimAtomTypeEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ClaimAtomTypeEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ClaimAtomTypeEncodeRequest
            if (!model.IsDefined(typeof(Stellar.ClaimAtomTypeEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ClaimAtomTypeEncodeRequest), false);
