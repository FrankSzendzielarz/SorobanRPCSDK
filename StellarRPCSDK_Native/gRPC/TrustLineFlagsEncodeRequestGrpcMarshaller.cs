...
{
    /// <summary>Custom marshaller for Stellar.TrustLineFlagsEncodeRequest</summary>
    public static class TrustLineFlagsEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static TrustLineFlagsEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TrustLineFlagsEncodeRequest
            if (!model.IsDefined(typeof(Stellar.TrustLineFlagsEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.TrustLineFlagsEncodeRequest), false);
