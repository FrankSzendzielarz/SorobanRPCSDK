...
{
    /// <summary>Custom marshaller for Stellar.SCSpecTypeMapDecodeResponse</summary>
    public static class SCSpecTypeMapDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SCSpecTypeMapDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCSpecTypeMapDecodeResponse
            if (!model.IsDefined(typeof(Stellar.SCSpecTypeMapDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SCSpecTypeMapDecodeResponse), false);
