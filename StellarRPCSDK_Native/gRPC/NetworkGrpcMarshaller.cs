...
{
    /// <summary>Custom marshaller for Stellar.Network</summary>
    public static class NetworkGrpcMarshaller
    {
        // Static constructor to configure type
        static NetworkGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            {
                var metaType = model.Add(typeof(Stellar.Network), false);
