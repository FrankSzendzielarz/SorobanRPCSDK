...
{
    /// <summary>Custom marshaller for Stellar.SetTrustLineFlagsOpEncodeResponse</summary>
    public static class SetTrustLineFlagsOpEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SetTrustLineFlagsOpEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SetTrustLineFlagsOpEncodeResponse
            if (!model.IsDefined(typeof(Stellar.SetTrustLineFlagsOpEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SetTrustLineFlagsOpEncodeResponse), false);
