...
{
    /// <summary>Custom marshaller for Stellar.SCEnvMetaEntryEncodeRequest</summary>
    public static class SCEnvMetaEntryEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SCEnvMetaEntryEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCEnvMetaEntryEncodeRequest
            if (!model.IsDefined(typeof(Stellar.SCEnvMetaEntryEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SCEnvMetaEntryEncodeRequest), false);
