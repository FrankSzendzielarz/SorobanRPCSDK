...
{
    /// <summary>Custom marshaller for Stellar.BucketMetadataDecodeResponse</summary>
    public static class BucketMetadataDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static BucketMetadataDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.BucketMetadataDecodeResponse
            if (!model.IsDefined(typeof(Stellar.BucketMetadataDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.BucketMetadataDecodeResponse), false);
