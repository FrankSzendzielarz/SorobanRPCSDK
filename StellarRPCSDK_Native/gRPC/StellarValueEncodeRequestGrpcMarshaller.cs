...
{
    /// <summary>Custom marshaller for Stellar.StellarValueEncodeRequest</summary>
    public static class StellarValueEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static StellarValueEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.StellarValueEncodeRequest
            if (!model.IsDefined(typeof(Stellar.StellarValueEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.StellarValueEncodeRequest), false);
