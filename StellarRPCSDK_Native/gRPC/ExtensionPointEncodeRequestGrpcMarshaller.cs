...
{
    /// <summary>Custom marshaller for Stellar.ExtensionPointEncodeRequest</summary>
    public static class ExtensionPointEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ExtensionPointEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ExtensionPointEncodeRequest
            if (!model.IsDefined(typeof(Stellar.ExtensionPointEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ExtensionPointEncodeRequest), false);
