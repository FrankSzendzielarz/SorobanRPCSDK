...
{
    /// <summary>Custom marshaller for Stellar.ClaimPredicateTypeDecodeRequest</summary>
    public static class ClaimPredicateTypeDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ClaimPredicateTypeDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ClaimPredicateTypeDecodeRequest
            if (!model.IsDefined(typeof(Stellar.ClaimPredicateTypeDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ClaimPredicateTypeDecodeRequest), false);
