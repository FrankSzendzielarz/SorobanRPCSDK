...
{
    /// <summary>Custom marshaller for Stellar.InvokeHostFunctionResultCodeEncodeResponse</summary>
    public static class InvokeHostFunctionResultCodeEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static InvokeHostFunctionResultCodeEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.InvokeHostFunctionResultCodeEncodeResponse
            if (!model.IsDefined(typeof(Stellar.InvokeHostFunctionResultCodeEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.InvokeHostFunctionResultCodeEncodeResponse), false);
