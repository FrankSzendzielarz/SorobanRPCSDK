...
{
    /// <summary>Custom marshaller for Stellar.SCSpecTypeEncodeRequest</summary>
    public static class SCSpecTypeEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SCSpecTypeEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCSpecTypeEncodeRequest
            if (!model.IsDefined(typeof(Stellar.SCSpecTypeEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SCSpecTypeEncodeRequest), false);
