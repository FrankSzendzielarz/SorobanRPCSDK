...
{
    /// <summary>Custom marshaller for Stellar.ContractCostTypeDecodeRequest</summary>
    public static class ContractCostTypeDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ContractCostTypeDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ContractCostTypeDecodeRequest
            if (!model.IsDefined(typeof(Stellar.ContractCostTypeDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ContractCostTypeDecodeRequest), false);
