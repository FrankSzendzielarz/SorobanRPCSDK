...
{
    /// <summary>Custom marshaller for Stellar.TransactionHistoryResultEntryEncodeRequest</summary>
    public static class TransactionHistoryResultEntryEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static TransactionHistoryResultEntryEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TransactionHistoryResultEntryEncodeRequest
            if (!model.IsDefined(typeof(Stellar.TransactionHistoryResultEntryEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.TransactionHistoryResultEntryEncodeRequest), false);
