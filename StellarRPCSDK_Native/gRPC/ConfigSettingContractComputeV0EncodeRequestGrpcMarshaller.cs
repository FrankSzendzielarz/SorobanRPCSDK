...
{
    /// <summary>Custom marshaller for Stellar.ConfigSettingContractComputeV0EncodeRequest</summary>
    public static class ConfigSettingContractComputeV0EncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ConfigSettingContractComputeV0EncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ConfigSettingContractComputeV0EncodeRequest
            if (!model.IsDefined(typeof(Stellar.ConfigSettingContractComputeV0EncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ConfigSettingContractComputeV0EncodeRequest), false);
