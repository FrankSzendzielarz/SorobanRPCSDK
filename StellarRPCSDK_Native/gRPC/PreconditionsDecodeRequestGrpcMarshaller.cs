...
{
    /// <summary>Custom marshaller for Stellar.PreconditionsDecodeRequest</summary>
    public static class PreconditionsDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static PreconditionsDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.PreconditionsDecodeRequest
            if (!model.IsDefined(typeof(Stellar.PreconditionsDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.PreconditionsDecodeRequest), false);
