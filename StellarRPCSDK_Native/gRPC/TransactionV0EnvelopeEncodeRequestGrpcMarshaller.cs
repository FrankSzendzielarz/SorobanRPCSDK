...
{
    /// <summary>Custom marshaller for Stellar.TransactionV0EnvelopeEncodeRequest</summary>
    public static class TransactionV0EnvelopeEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static TransactionV0EnvelopeEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TransactionV0EnvelopeEncodeRequest
            if (!model.IsDefined(typeof(Stellar.TransactionV0EnvelopeEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.TransactionV0EnvelopeEncodeRequest), false);
