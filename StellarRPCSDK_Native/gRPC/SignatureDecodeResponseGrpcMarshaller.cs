...
{
    /// <summary>Custom marshaller for Stellar.SignatureDecodeResponse</summary>
    public static class SignatureDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SignatureDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SignatureDecodeResponse
            if (!model.IsDefined(typeof(Stellar.SignatureDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SignatureDecodeResponse), false);
