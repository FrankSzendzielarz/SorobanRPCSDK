...
{
    /// <summary>Custom marshaller for Stellar.BumpSequenceOpEncodeResponse</summary>
    public static class BumpSequenceOpEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static BumpSequenceOpEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.BumpSequenceOpEncodeResponse
            if (!model.IsDefined(typeof(Stellar.BumpSequenceOpEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.BumpSequenceOpEncodeResponse), false);
