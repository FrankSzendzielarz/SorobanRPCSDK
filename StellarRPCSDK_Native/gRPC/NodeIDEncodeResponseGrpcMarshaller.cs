...
{
    /// <summary>Custom marshaller for Stellar.NodeIDEncodeResponse</summary>
    public static class NodeIDEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static NodeIDEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.NodeIDEncodeResponse
            if (!model.IsDefined(typeof(Stellar.NodeIDEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.NodeIDEncodeResponse), false);
