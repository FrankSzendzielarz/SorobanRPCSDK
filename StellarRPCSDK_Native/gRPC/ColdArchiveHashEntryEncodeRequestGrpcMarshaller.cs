...
{
    /// <summary>Custom marshaller for Stellar.ColdArchiveHashEntryEncodeRequest</summary>
    public static class ColdArchiveHashEntryEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ColdArchiveHashEntryEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ColdArchiveHashEntryEncodeRequest
            if (!model.IsDefined(typeof(Stellar.ColdArchiveHashEntryEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ColdArchiveHashEntryEncodeRequest), false);
