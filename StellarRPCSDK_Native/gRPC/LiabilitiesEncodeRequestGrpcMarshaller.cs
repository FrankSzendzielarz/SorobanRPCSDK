...
{
    /// <summary>Custom marshaller for Stellar.LiabilitiesEncodeRequest</summary>
    public static class LiabilitiesEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static LiabilitiesEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.LiabilitiesEncodeRequest
            if (!model.IsDefined(typeof(Stellar.LiabilitiesEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.LiabilitiesEncodeRequest), false);
