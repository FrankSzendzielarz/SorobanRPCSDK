...
{
    /// <summary>Custom marshaller for Stellar.SorobanAddressCredentialsEncodeRequest</summary>
    public static class SorobanAddressCredentialsEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SorobanAddressCredentialsEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SorobanAddressCredentialsEncodeRequest
            if (!model.IsDefined(typeof(Stellar.SorobanAddressCredentialsEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SorobanAddressCredentialsEncodeRequest), false);
