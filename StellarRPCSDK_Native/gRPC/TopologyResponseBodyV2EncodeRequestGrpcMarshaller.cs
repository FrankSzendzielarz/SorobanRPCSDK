...
{
    /// <summary>Custom marshaller for Stellar.TopologyResponseBodyV2EncodeRequest</summary>
    public static class TopologyResponseBodyV2EncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static TopologyResponseBodyV2EncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TopologyResponseBodyV2EncodeRequest
            if (!model.IsDefined(typeof(Stellar.TopologyResponseBodyV2EncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.TopologyResponseBodyV2EncodeRequest), false);
