...
{
    /// <summary>Custom marshaller for Stellar.LedgerCloseMetaDecodeRequest</summary>
    public static class LedgerCloseMetaDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static LedgerCloseMetaDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.LedgerCloseMetaDecodeRequest
            if (!model.IsDefined(typeof(Stellar.LedgerCloseMetaDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.LedgerCloseMetaDecodeRequest), false);
