...
{
    /// <summary>Custom marshaller for Stellar.ColdArchiveDeletedLeafEncodeResponse</summary>
    public static class ColdArchiveDeletedLeafEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ColdArchiveDeletedLeafEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ColdArchiveDeletedLeafEncodeResponse
            if (!model.IsDefined(typeof(Stellar.ColdArchiveDeletedLeafEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ColdArchiveDeletedLeafEncodeResponse), false);
