...
{
    /// <summary>Custom marshaller for Stellar.ManageBuyOfferResultCodeEncodeResponse</summary>
    public static class ManageBuyOfferResultCodeEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ManageBuyOfferResultCodeEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ManageBuyOfferResultCodeEncodeResponse
            if (!model.IsDefined(typeof(Stellar.ManageBuyOfferResultCodeEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ManageBuyOfferResultCodeEncodeResponse), false);
