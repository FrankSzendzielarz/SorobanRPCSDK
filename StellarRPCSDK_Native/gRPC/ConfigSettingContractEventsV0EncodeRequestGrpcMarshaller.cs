...
{
    /// <summary>Custom marshaller for Stellar.ConfigSettingContractEventsV0EncodeRequest</summary>
    public static class ConfigSettingContractEventsV0EncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ConfigSettingContractEventsV0EncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ConfigSettingContractEventsV0EncodeRequest
            if (!model.IsDefined(typeof(Stellar.ConfigSettingContractEventsV0EncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ConfigSettingContractEventsV0EncodeRequest), false);
