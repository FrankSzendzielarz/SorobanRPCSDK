...
{
    /// <summary>Custom marshaller for Stellar.TopologyResponseBodyV1DecodeRequest</summary>
    public static class TopologyResponseBodyV1DecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static TopologyResponseBodyV1DecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TopologyResponseBodyV1DecodeRequest
            if (!model.IsDefined(typeof(Stellar.TopologyResponseBodyV1DecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.TopologyResponseBodyV1DecodeRequest), false);
