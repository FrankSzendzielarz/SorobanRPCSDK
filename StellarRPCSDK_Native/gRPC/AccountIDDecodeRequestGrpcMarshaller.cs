...
{
    /// <summary>Custom marshaller for Stellar.AccountIDDecodeRequest</summary>
    public static class AccountIDDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static AccountIDDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.AccountIDDecodeRequest
            if (!model.IsDefined(typeof(Stellar.AccountIDDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.AccountIDDecodeRequest), false);
