...
{
    /// <summary>Custom marshaller for Stellar.PathPaymentStrictReceiveResultCodeEncodeRequest</summary>
    public static class PathPaymentStrictReceiveResultCodeEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static PathPaymentStrictReceiveResultCodeEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.PathPaymentStrictReceiveResultCodeEncodeRequest
            if (!model.IsDefined(typeof(Stellar.PathPaymentStrictReceiveResultCodeEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.PathPaymentStrictReceiveResultCodeEncodeRequest), false);
