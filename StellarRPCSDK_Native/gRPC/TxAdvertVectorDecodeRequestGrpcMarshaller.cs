...
{
    /// <summary>Custom marshaller for Stellar.TxAdvertVectorDecodeRequest</summary>
    public static class TxAdvertVectorDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static TxAdvertVectorDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TxAdvertVectorDecodeRequest
            if (!model.IsDefined(typeof(Stellar.TxAdvertVectorDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.TxAdvertVectorDecodeRequest), false);
