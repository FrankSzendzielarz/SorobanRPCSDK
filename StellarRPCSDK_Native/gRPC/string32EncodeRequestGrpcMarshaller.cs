...
{
    /// <summary>Custom marshaller for Stellar.string32EncodeRequest</summary>
    public static class string32EncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static string32EncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.string32EncodeRequest
            if (!model.IsDefined(typeof(Stellar.string32EncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.string32EncodeRequest), false);
