...
{
    /// <summary>Custom marshaller for Stellar.LedgerFootprintDecodeRequest</summary>
    public static class LedgerFootprintDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static LedgerFootprintDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.LedgerFootprintDecodeRequest
            if (!model.IsDefined(typeof(Stellar.LedgerFootprintDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.LedgerFootprintDecodeRequest), false);
