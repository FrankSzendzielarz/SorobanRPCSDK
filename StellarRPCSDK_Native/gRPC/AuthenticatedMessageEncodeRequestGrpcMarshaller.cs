...
{
    /// <summary>Custom marshaller for Stellar.AuthenticatedMessageEncodeRequest</summary>
    public static class AuthenticatedMessageEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static AuthenticatedMessageEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.AuthenticatedMessageEncodeRequest
            if (!model.IsDefined(typeof(Stellar.AuthenticatedMessageEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.AuthenticatedMessageEncodeRequest), false);
