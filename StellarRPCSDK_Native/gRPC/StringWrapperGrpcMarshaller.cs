...
{
    /// <summary>Custom marshaller for Stellar.StringWrapper</summary>
    public static class StringWrapperGrpcMarshaller
    {
        // Static constructor to configure type
        static StringWrapperGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.StringWrapper
            if (!model.IsDefined(typeof(Stellar.StringWrapper)))
            {
                var metaType = model.Add(typeof(Stellar.StringWrapper), false);
