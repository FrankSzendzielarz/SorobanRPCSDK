...
{
    /// <summary>Custom marshaller for Stellar.TransactionV1EnvelopeDecodeRequest</summary>
    public static class TransactionV1EnvelopeDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static TransactionV1EnvelopeDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TransactionV1EnvelopeDecodeRequest
            if (!model.IsDefined(typeof(Stellar.TransactionV1EnvelopeDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.TransactionV1EnvelopeDecodeRequest), false);
