...
{
    /// <summary>Custom marshaller for Stellar.SurveyMessageResponseTypeDecodeResponse</summary>
    public static class SurveyMessageResponseTypeDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SurveyMessageResponseTypeDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SurveyMessageResponseTypeDecodeResponse
            if (!model.IsDefined(typeof(Stellar.SurveyMessageResponseTypeDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SurveyMessageResponseTypeDecodeResponse), false);
