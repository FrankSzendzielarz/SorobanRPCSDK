...
{
    /// <summary>Custom marshaller for Stellar.AccountMergeResultCodeDecodeRequest</summary>
    public static class AccountMergeResultCodeDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static AccountMergeResultCodeDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.AccountMergeResultCodeDecodeRequest
            if (!model.IsDefined(typeof(Stellar.AccountMergeResultCodeDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.AccountMergeResultCodeDecodeRequest), false);
