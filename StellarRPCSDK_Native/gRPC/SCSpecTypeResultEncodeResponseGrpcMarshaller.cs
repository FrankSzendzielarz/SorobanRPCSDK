...
{
    /// <summary>Custom marshaller for Stellar.SCSpecTypeResultEncodeResponse</summary>
    public static class SCSpecTypeResultEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SCSpecTypeResultEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCSpecTypeResultEncodeResponse
            if (!model.IsDefined(typeof(Stellar.SCSpecTypeResultEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SCSpecTypeResultEncodeResponse), false);
