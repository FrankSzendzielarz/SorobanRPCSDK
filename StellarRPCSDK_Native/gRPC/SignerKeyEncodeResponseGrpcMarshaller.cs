...
{
    /// <summary>Custom marshaller for Stellar.SignerKeyEncodeResponse</summary>
    public static class SignerKeyEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SignerKeyEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SignerKeyEncodeResponse
            if (!model.IsDefined(typeof(Stellar.SignerKeyEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SignerKeyEncodeResponse), false);
