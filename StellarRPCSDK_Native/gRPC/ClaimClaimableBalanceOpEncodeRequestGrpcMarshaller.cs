...
{
    /// <summary>Custom marshaller for Stellar.ClaimClaimableBalanceOpEncodeRequest</summary>
    public static class ClaimClaimableBalanceOpEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ClaimClaimableBalanceOpEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ClaimClaimableBalanceOpEncodeRequest
            if (!model.IsDefined(typeof(Stellar.ClaimClaimableBalanceOpEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ClaimClaimableBalanceOpEncodeRequest), false);
