...
{
    /// <summary>Custom marshaller for Stellar.MessageTypeDecodeRequest</summary>
    public static class MessageTypeDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static MessageTypeDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.MessageTypeDecodeRequest
            if (!model.IsDefined(typeof(Stellar.MessageTypeDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.MessageTypeDecodeRequest), false);
