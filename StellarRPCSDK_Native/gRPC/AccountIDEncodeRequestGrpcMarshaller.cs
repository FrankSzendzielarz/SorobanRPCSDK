...
{
    /// <summary>Custom marshaller for Stellar.AccountIDEncodeRequest</summary>
    public static class AccountIDEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static AccountIDEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.AccountIDEncodeRequest
            if (!model.IsDefined(typeof(Stellar.AccountIDEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.AccountIDEncodeRequest), false);
