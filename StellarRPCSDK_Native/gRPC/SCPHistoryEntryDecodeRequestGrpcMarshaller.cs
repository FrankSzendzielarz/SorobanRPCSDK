...
{
    /// <summary>Custom marshaller for Stellar.SCPHistoryEntryDecodeRequest</summary>
    public static class SCPHistoryEntryDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static SCPHistoryEntryDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCPHistoryEntryDecodeRequest
            if (!model.IsDefined(typeof(Stellar.SCPHistoryEntryDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.SCPHistoryEntryDecodeRequest), false);
