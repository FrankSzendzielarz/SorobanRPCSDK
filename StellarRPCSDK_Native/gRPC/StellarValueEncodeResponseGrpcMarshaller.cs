...
{
    /// <summary>Custom marshaller for Stellar.StellarValueEncodeResponse</summary>
    public static class StellarValueEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static StellarValueEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.StellarValueEncodeResponse
            if (!model.IsDefined(typeof(Stellar.StellarValueEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.StellarValueEncodeResponse), false);
