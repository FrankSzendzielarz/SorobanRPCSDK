...
{
    /// <summary>Custom marshaller for Stellar.ClawbackClaimableBalanceResultCodeDecodeResponse</summary>
    public static class ClawbackClaimableBalanceResultCodeDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ClawbackClaimableBalanceResultCodeDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ClawbackClaimableBalanceResultCodeDecodeResponse
            if (!model.IsDefined(typeof(Stellar.ClawbackClaimableBalanceResultCodeDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ClawbackClaimableBalanceResultCodeDecodeResponse), false);
