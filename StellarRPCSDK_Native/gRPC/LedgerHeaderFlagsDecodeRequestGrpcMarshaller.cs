...
{
    /// <summary>Custom marshaller for Stellar.LedgerHeaderFlagsDecodeRequest</summary>
    public static class LedgerHeaderFlagsDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static LedgerHeaderFlagsDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.LedgerHeaderFlagsDecodeRequest
            if (!model.IsDefined(typeof(Stellar.LedgerHeaderFlagsDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.LedgerHeaderFlagsDecodeRequest), false);
