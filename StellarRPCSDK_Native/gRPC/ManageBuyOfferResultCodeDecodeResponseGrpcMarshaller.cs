...
{
    /// <summary>Custom marshaller for Stellar.ManageBuyOfferResultCodeDecodeResponse</summary>
    public static class ManageBuyOfferResultCodeDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static ManageBuyOfferResultCodeDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ManageBuyOfferResultCodeDecodeResponse
            if (!model.IsDefined(typeof(Stellar.ManageBuyOfferResultCodeDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.ManageBuyOfferResultCodeDecodeResponse), false);
