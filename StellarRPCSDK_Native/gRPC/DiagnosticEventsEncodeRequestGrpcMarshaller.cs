...
{
    /// <summary>Custom marshaller for Stellar.DiagnosticEventsEncodeRequest</summary>
    public static class DiagnosticEventsEncodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static DiagnosticEventsEncodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.DiagnosticEventsEncodeRequest
            if (!model.IsDefined(typeof(Stellar.DiagnosticEventsEncodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.DiagnosticEventsEncodeRequest), false);
