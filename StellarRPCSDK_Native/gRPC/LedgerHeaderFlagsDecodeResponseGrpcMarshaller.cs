...
{
    /// <summary>Custom marshaller for Stellar.LedgerHeaderFlagsDecodeResponse</summary>
    public static class LedgerHeaderFlagsDecodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static LedgerHeaderFlagsDecodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.LedgerHeaderFlagsDecodeResponse
            if (!model.IsDefined(typeof(Stellar.LedgerHeaderFlagsDecodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.LedgerHeaderFlagsDecodeResponse), false);
