...
{
    /// <summary>Custom marshaller for Stellar.TimePointDecodeRequest</summary>
    public static class TimePointDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static TimePointDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TimePointDecodeRequest
            if (!model.IsDefined(typeof(Stellar.TimePointDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.TimePointDecodeRequest), false);
