...
{
    /// <summary>Custom marshaller for Stellar.TimeSlicedPeerDataListDecodeRequest</summary>
    public static class TimeSlicedPeerDataListDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static TimeSlicedPeerDataListDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TimeSlicedPeerDataListDecodeRequest
            if (!model.IsDefined(typeof(Stellar.TimeSlicedPeerDataListDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.TimeSlicedPeerDataListDecodeRequest), false);
