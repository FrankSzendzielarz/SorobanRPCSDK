...
{
    /// <summary>Custom marshaller for Stellar.EvictionIteratorDecodeRequest</summary>
    public static class EvictionIteratorDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static EvictionIteratorDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.EvictionIteratorDecodeRequest
            if (!model.IsDefined(typeof(Stellar.EvictionIteratorDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.EvictionIteratorDecodeRequest), false);
