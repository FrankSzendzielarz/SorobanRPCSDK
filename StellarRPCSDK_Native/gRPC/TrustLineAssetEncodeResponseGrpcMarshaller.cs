...
{
    /// <summary>Custom marshaller for Stellar.TrustLineAssetEncodeResponse</summary>
    public static class TrustLineAssetEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static TrustLineAssetEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TrustLineAssetEncodeResponse
            if (!model.IsDefined(typeof(Stellar.TrustLineAssetEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.TrustLineAssetEncodeResponse), false);
