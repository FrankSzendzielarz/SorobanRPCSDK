...
{
    /// <summary>Custom marshaller for Stellar.SCSpecTypeTupleEncodeResponse</summary>
    public static class SCSpecTypeTupleEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static SCSpecTypeTupleEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.SCSpecTypeTupleEncodeResponse
            if (!model.IsDefined(typeof(Stellar.SCSpecTypeTupleEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.SCSpecTypeTupleEncodeResponse), false);
