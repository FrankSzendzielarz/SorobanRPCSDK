...
{
    /// <summary>Custom marshaller for Stellar.AlphaNum4EncodeResponse</summary>
    public static class AlphaNum4EncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static AlphaNum4EncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.AlphaNum4EncodeResponse
            if (!model.IsDefined(typeof(Stellar.AlphaNum4EncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.AlphaNum4EncodeResponse), false);
