...
{
    /// <summary>Custom marshaller for Stellar.TxSetComponentTypeEncodeResponse</summary>
    public static class TxSetComponentTypeEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static TxSetComponentTypeEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.TxSetComponentTypeEncodeResponse
            if (!model.IsDefined(typeof(Stellar.TxSetComponentTypeEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.TxSetComponentTypeEncodeResponse), false);
