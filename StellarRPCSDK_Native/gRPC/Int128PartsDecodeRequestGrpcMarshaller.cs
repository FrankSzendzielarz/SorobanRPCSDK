...
{
    /// <summary>Custom marshaller for Stellar.Int128PartsDecodeRequest</summary>
    public static class Int128PartsDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static Int128PartsDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.Int128PartsDecodeRequest
            if (!model.IsDefined(typeof(Stellar.Int128PartsDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.Int128PartsDecodeRequest), false);
