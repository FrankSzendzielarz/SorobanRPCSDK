...
{
    /// <summary>Custom marshaller for Stellar.InflationPayoutEncodeResponse</summary>
    public static class InflationPayoutEncodeResponseGrpcMarshaller
    {
        // Static constructor to configure type
        static InflationPayoutEncodeResponseGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.InflationPayoutEncodeResponse
            if (!model.IsDefined(typeof(Stellar.InflationPayoutEncodeResponse)))
            {
                var metaType = model.Add(typeof(Stellar.InflationPayoutEncodeResponse), false);
