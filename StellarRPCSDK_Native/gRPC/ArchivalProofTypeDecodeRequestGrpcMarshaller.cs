...
{
    /// <summary>Custom marshaller for Stellar.ArchivalProofTypeDecodeRequest</summary>
    public static class ArchivalProofTypeDecodeRequestGrpcMarshaller
    {
        // Static constructor to configure type
        static ArchivalProofTypeDecodeRequestGrpcMarshaller()
        {
            ConfigureTypes();
        }
        ...
        public static void ConfigureTypes()
        {
            ...
            // Configure Stellar.ArchivalProofTypeDecodeRequest
            if (!model.IsDefined(typeof(Stellar.ArchivalProofTypeDecodeRequest)))
            {
                var metaType = model.Add(typeof(Stellar.ArchivalProofTypeDecodeRequest), false);
