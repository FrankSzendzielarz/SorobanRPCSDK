...
{
    public override ClawbackClaimableBalanceResultCode Discriminator => CLAWBACK_CLAIMABLE_BALANCE_SUCCESS;
...
{
    public override ClawbackClaimableBalanceResultCode Discriminator => CLAWBACK_CLAIMABLE_BALANCE_DOES_NOT_EXIST;
...
{
    public override ClawbackClaimableBalanceResultCode Discriminator => CLAWBACK_CLAIMABLE_BALANCE_NOT_ISSUER;
...
{
    public override ClawbackClaimableBalanceResultCode Discriminator => CLAWBACK_CLAIMABLE_BALANCE_NOT_CLAWBACK_ENABLED;
