    ...
    public static HashIDPreimage Decode(XdrReader stream)
    {
        ...
        switch (discriminator)
        {
            case ENVELOPE_TYPE_OP_ID:
                ...
                result_ENVELOPE_TYPE_OP_ID.operationID = Xdr.Decode(stream);
            ...
            case ENVELOPE_TYPE_POOL_REVOKE_OP_ID:
                ...
                result_ENVELOPE_TYPE_POOL_REVOKE_OP_ID.revokeID = Xdr.Decode(stream);
            ...
            case ENVELOPE_TYPE_CONTRACT_ID:
                ...
                result_ENVELOPE_TYPE_CONTRACT_ID.contractID = Xdr.Decode(stream);
            ...
            case ENVELOPE_TYPE_SOROBAN_AUTHORIZATION:
                ...
                result_ENVELOPE_TYPE_SOROBAN_AUTHORIZATION.sorobanAuthorization = Xdr.Decode(stream);
