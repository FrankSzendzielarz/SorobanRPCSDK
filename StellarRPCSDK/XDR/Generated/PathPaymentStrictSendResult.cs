    ...
    public static partial class PathPaymentStrictSendResultXdr
    {
        public static void Encode(XdrWriter stream, PathPaymentStrictSendResult value)
        {
            ...
            switch (value)
            {
                ...
                Xdr.Encode(stream, case_PATH_PAYMENT_STRICT_SEND_SUCCESS.success);
                break;
        ...
        public static PathPaymentStrictSendResult Decode(XdrReader stream)
        {
            ...
            switch (discriminator)
            {
                ...
                result_PATH_PAYMENT_STRICT_SEND_SUCCESS.                 = Xdr.Decode(stream);
                ...
                result_PATH_PAYMENT_STRICT_SEND_NO_ISSUER.                 = AssetXdr.Decode(stream);
