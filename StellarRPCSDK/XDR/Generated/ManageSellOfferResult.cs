...
namespace stellar {
    ...
    {
        public override int Discriminator => MANAGE_SELL_OFFER_SUCCESS;
    ...
    public static partial class ManageSellOfferResultXdr
    {
        ...
        public static ManageSellOfferResult Decode(XdrReader stream)
        {
            ...
            switch (discriminator)
            {
                ...
                result_MANAGE_SELL_OFFER_SUCCESS.                 = ManageOfferSuccessResultXdr.Decode(stream);
