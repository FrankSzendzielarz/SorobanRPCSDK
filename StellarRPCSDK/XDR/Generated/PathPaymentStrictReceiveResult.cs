...
{
    public override PathPaymentStrictReceiveResultCode Discriminator => PATH_PAYMENT_STRICT_RECEIVE_SUCCESS;
...
{
    public override PathPaymentStrictReceiveResultCode Discriminator => PATH_PAYMENT_STRICT_RECEIVE_MALFORMED;
...
{
    public override PathPaymentStrictReceiveResultCode Discriminator => PATH_PAYMENT_STRICT_RECEIVE_UNDERFUNDED;
...
{
    public override PathPaymentStrictReceiveResultCode Discriminator => PATH_PAYMENT_STRICT_RECEIVE_SRC_NO_TRUST;
...
{
    public override PathPaymentStrictReceiveResultCode Discriminator => PATH_PAYMENT_STRICT_RECEIVE_SRC_NOT_AUTHORIZED;
...
{
    public override PathPaymentStrictReceiveResultCode Discriminator => PATH_PAYMENT_STRICT_RECEIVE_NO_DESTINATION;
...
{
    public override PathPaymentStrictReceiveResultCode Discriminator => PATH_PAYMENT_STRICT_RECEIVE_NO_TRUST;
...
{
    public override PathPaymentStrictReceiveResultCode Discriminator => PATH_PAYMENT_STRICT_RECEIVE_NOT_AUTHORIZED;
...
{
    public override PathPaymentStrictReceiveResultCode Discriminator => PATH_PAYMENT_STRICT_RECEIVE_LINE_FULL;
...
{
    public override PathPaymentStrictReceiveResultCode Discriminator => PATH_PAYMENT_STRICT_RECEIVE_NO_ISSUER;
...
{
    public override PathPaymentStrictReceiveResultCode Discriminator => PATH_PAYMENT_STRICT_RECEIVE_TOO_FEW_OFFERS;
...
{
    public override PathPaymentStrictReceiveResultCode Discriminator => PATH_PAYMENT_STRICT_RECEIVE_OFFER_CROSS_SELF;
...
{
    public override PathPaymentStrictReceiveResultCode Discriminator => PATH_PAYMENT_STRICT_RECEIVE_OVER_SENDMAX;
    ...
    public static PathPaymentStrictReceiveResult Decode(XdrReader stream)
    {
        ...
        switch (discriminator)
        {
            case PATH_PAYMENT_STRICT_RECEIVE_SUCCESS:
                ...
                result_PATH_PAYMENT_STRICT_RECEIVE_SUCCESS.success = Xdr.Decode(stream);
