...
{
    public override ManageDataResultCode Discriminator => MANAGE_DATA_SUCCESS;
...
{
    public override ManageDataResultCode Discriminator => MANAGE_DATA_NOT_SUPPORTED_YET;
...
{
    public override ManageDataResultCode Discriminator => MANAGE_DATA_NAME_NOT_FOUND;
...
{
    public override ManageDataResultCode Discriminator => MANAGE_DATA_LOW_RESERVE;
...
{
    public override ManageDataResultCode Discriminator => MANAGE_DATA_INVALID_NAME;
