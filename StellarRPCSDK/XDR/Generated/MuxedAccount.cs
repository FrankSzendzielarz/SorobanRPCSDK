...
{
    public override CryptoKeyType Discriminator => KEY_TYPE_ED25519;
...
{
    public override CryptoKeyType Discriminator => KEY_TYPE_MUXED_ED25519;
    ...
    public static MuxedAccount Decode(XdrReader stream)
    {
        ...
        switch (discriminator)
        {
            ...
            case KEY_TYPE_MUXED_ED25519:
                ...
                result_KEY_TYPE_MUXED_ED25519.med25519 = Xdr.Decode(stream);
