...
{
    public override BeginSponsoringFutureReservesResultCode Discriminator => BEGIN_SPONSORING_FUTURE_RESERVES_SUCCESS;
...
{
    public override BeginSponsoringFutureReservesResultCode Discriminator => BEGIN_SPONSORING_FUTURE_RESERVES_MALFORMED;
...
{
    public override BeginSponsoringFutureReservesResultCode Discriminator => BEGIN_SPONSORING_FUTURE_RESERVES_ALREADY_SPONSORED;
...
{
    public override BeginSponsoringFutureReservesResultCode Discriminator => BEGIN_SPONSORING_FUTURE_RESERVES_RECURSIVE;
