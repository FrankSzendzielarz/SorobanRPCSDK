...
namespace stellar {
    ...
    {
        public override EnvelopeType Discriminator => ENVELOPE_TYPE_TX_V0;
    ...
    {
        public override EnvelopeType Discriminator => ENVELOPE_TYPE_TX;
    ...
    {
        public override EnvelopeType Discriminator => ENVELOPE_TYPE_TX_FEE_BUMP;
